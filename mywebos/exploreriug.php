...
<head>
<title>
	Liste des applications concus par des utilisateurs - /<?php echo $currentdir; ?>
</title>
</head>
<body>
...
<table width=100%>
<tr><td>
<a href="<? echo $_self . "?path=";  ?>">Racine/Actualiser</a> | 
</td><td align=right>
WebOS generateur
</td></tr>
</table>
...
<td valign=top width=80%>
	...
	<?php
		...
		if ( ! $foundone)
		{
			echo "<tr><td colspan=3 align=center><b>Pour ouvrir une applis Web cliquez son fichier PHP...</b></td></tr>";
		}
	?>
