...
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;">Catalogue liste (session Rynna WebOS) :<br>(CommandLine) - Utilisable en cas de problème d'affichage en mode fenêtré (IUG).<br><br>&gt; Choisissez le programme a exécuter :</span></div>
