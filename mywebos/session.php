...
<body>
<div id="Layer21" style="position:fixed;text-align:left;left:0;right:0;bottom:0;height:15px;z-index:505;" onmouseenter="ShowObject('Layer22', 1);AnimateCss('Layer22', 'animate-fade-in', 5, 500);return false;">
</div>
<div id="Layer1" style="position:absolute;text-align:center;left:2202px;top:1387px;width:755px;height:436px;z-index:506;">
...
<div id="wb_Image54" style="position:absolute;left:13px;top:405px;width:58px;height:29px;z-index:72;">
<a href="#" onclick="$('#jQueryDialog87').dialog('open');return false;"><img src="images/liligoicone.png" id="Image54" alt=""></a></div>
<div id="wb_Text75" style="position:absolute;left:15px;top:450px;width:55px;height:16px;text-align:center;z-index:73;">
...
<input type="button" id="Button31" onclick="$('#jQueryDialog65').dialog('open');$('#jQueryDialog64').dialog('close');return false;" name="" value="Simulateur iPhone X" style="position:absolute;left:20px;top:28px;width:317px;height:25px;z-index:307;">
<input type="button" id="Button32" onclick="$('#jQueryDialog66').dialog('open');$('#jQueryDialog64').dialog('close');return false;" name="" value="Simulateur Samsung Galaxy s8" style="position:absolute;left:20px;top:68px;width:317px;height:25px;z-index:308;">
</div>
...
<div id="wb_Text108" style="position:absolute;left:12px;top:13px;width:540px;height:195px;z-index:479;">
...
<input type="button" id="Button5" onclick="$('#jQueryDialog83').dialog('close');return false;" name="" value="Fermer" style="position:absolute;left:819px;top:467px;width:163px;height:25px;z-index:487;">
<div id="wb_Text44" style="position:absolute;left:13px;top:17px;width:251px;height:16px;z-index:488;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Links-Dialog</span></div>
<div id="wb_Text50" style="position:absolute;left:13px;top:93px;width:251px;height:16px;z-index:489;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Aides Audio</span></div>
<div id="wb_FontAwesomeIcon6" style="position:absolute;left:14px;top:33px;width:964px;height:42px;text-align:center;z-index:490;">
<a href="#" onclick="$('#jQueryDialog84').dialog('open');return false;"><div id="FontAwesomeIcon6"><i class="fa fa-anchor">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon8" style="position:absolute;left:14px;top:109px;width:964px;height:42px;text-align:center;z-index:491;">
...
<div id="wb_Text74" style="position:absolute;left:10px;top:20px;width:959px;height:48px;z-index:494;">
...
<div id="jQueryDialog87" style="z-index:643;" title="Liligo - Voyages Hotel, Voitures, S&#233;jours">
