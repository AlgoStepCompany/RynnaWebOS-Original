...
$('#wb_Extension1').FileUploader({ headings: ['Nom', 'Taille', 'Vider la liste'], script: 'fileuploader.php' });
   ...
   var jQueryDialog52Options =
   {
      width: 255,
      height: 327,
      position: { my: 'left top', at: 'left+313 top+37', of: window },
      resizable: false,
      draggable: false,
      closeOnEscape: false,
      show: {effect: 'slide', direction: 'up'},
...
<div id="jQueryDialog3" style="z-index:541;" title="Mes applications install&#233;es (Applis G&#233;n&#233;rales)">
...
<div id="wb_Image60" style="position:absolute;left:601px;top:273px;width:58px;height:58px;z-index:80;">
<a href="#" onclick="$('#jQueryDialog93').dialog('open');return false;"><img src="images/Stellarium-logo-300x300.png" id="Image60" alt=""></a></div>
<div id="wb_Text84" style="position:absolute;left:601px;top:343px;width:59px;height:14px;text-align:center;z-index:81;">
<span style="color:#000000;font-family:Arial;font-size:11px;">Stellarium</span></div>
</div>

<div id="jQueryDialog4" style="z-index:542;" title="Calculatrice (system/program/calculatrice)">
<object data="addeosapps/calc.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog5" style="z-index:543;" title="Explorateur de fichiers - Votre espace personnel (50 Go maximum)">
<div id="jQueryTabs2" style="position:absolute;left:7px;top:9px;width:956px;height:519px;z-index:86;">
<ul>
...
<div id="jQueryDialog8" style="z-index:544;" title="Navigateur web StartPage (all&#233;g&#233;, sans onglet) [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/navigateur.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog14" style="z-index:545;" title="Editeur de texte (FullPro CK Series 2016)">
<object data="system/program/texteditor/editor.html" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog19" style="z-index:546;" title="Rynna Search (Rechercher une page du WebOS)">
<form name="SiteSearch1_form" id="SiteSearch1_form" accept-charset="UTF-8" onsubmit="return searchPage(features)">
<input type="text" id="SiteSearch1" style="position:absolute;left:130px;top:49px;width:350px;height:20px;line-height:20px;z-index:89;" name="SiteSearch1" value="" spellcheck="false" placeholder="Rechercher un programme, une fen&#234;tre, un script"></form>
<div id="SiteSearch1_dialog" title="Resultats"></div>
<input type="button" id="Button15" onclick="searchPage();return false;" name="Search" value="Rechercher" style="position:absolute;left:383px;top:80px;width:96px;height:25px;z-index:90;">
<div id="wb_FontAwesomeIcon20" style="position:absolute;left:11px;top:16px;width:103px;height:97px;text-align:center;z-index:91;">
...
<div id="jQueryDialog23" style="z-index:547;" title="Jeu de Hasard (system/program/dee)">
<object data="addeosapps/deeint.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog28" style="z-index:548;" title="WordPad - Editeur de texte avanc&#233;">
<object data="addeosapps/wordpad.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog7" style="z-index:549;" title="Informations sur votre location - M&#233;t&#233;o temps r&#233;el [NON COMPATIBLE EN HTTPS]">
...
<div id="jQueryDialog11" style="z-index:553;" title="Param&#232;tres et aides suppl&#233;mentaires">
<div id="wb_MaterialIcon5" style="position:absolute;left:26px;top:24px;width:96px;height:79px;text-align:center;z-index:95;">
...
<div id="wb_Text1" style="position:absolute;left:8px;top:123px;width:124px;height:36px;text-align:center;z-index:96;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Informations sur le WebOS</strong></span></div>
<div id="wb_MaterialIcon6" style="position:absolute;left:181px;top:24px;width:98px;height:79px;text-align:center;z-index:97;">
...
<div id="wb_Text4" style="position:absolute;left:168px;top:123px;width:124px;height:54px;text-align:center;z-index:98;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Tester la connexion internet</strong></span></div>
<div id="wb_MaterialIcon7" style="position:absolute;left:336px;top:24px;width:91px;height:79px;text-align:center;z-index:99;">
...
<div id="wb_Text11" style="position:absolute;left:319px;top:123px;width:124px;height:36px;text-align:center;z-index:100;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Connaître mon adresse IP</strong></span></div>
<div id="wb_MaterialIcon8" style="position:absolute;left:499px;top:24px;width:89px;height:79px;text-align:center;z-index:101;">
...
<div id="wb_Text14" style="position:absolute;left:484px;top:123px;width:124px;height:36px;text-align:center;z-index:102;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Supprimer votre compte</strong></span></div>
<div id="wb_MaterialIcon9" style="position:absolute;left:25px;top:201px;width:99px;height:76px;text-align:center;z-index:103;">
...
<div id="wb_Text16" style="position:absolute;left:8px;top:285px;width:124px;height:36px;text-align:center;z-index:104;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Tester mon clavier</strong></span></div>
<div id="wb_MaterialIcon10" style="position:absolute;left:186px;top:206px;width:89px;height:71px;text-align:center;z-index:105;">
...
<div id="wb_Text29" style="position:absolute;left:168px;top:285px;width:124px;height:54px;text-align:center;z-index:106;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Configuration de l'interface personnelle</strong></span></div>
<div id="wb_MaterialIcon11" style="position:absolute;left:341px;top:201px;width:81px;height:76px;text-align:center;z-index:107;">
...
<div id="wb_Text30" style="position:absolute;left:319px;top:285px;width:124px;height:36px;text-align:center;z-index:108;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Verifier la protection</strong></span></div>
<div id="wb_MaterialIcon12" style="position:absolute;left:510px;top:199px;width:78px;height:86px;text-align:center;z-index:109;">
<a href="#" onclick="$('#jQueryDialog38').dialog('open');return false;"><div id="MaterialIcon12"><i class="material-icons">&#xe8df;</i></div></a></div>
<div id="wb_Text31" style="position:absolute;left:487px;top:285px;width:124px;height:36px;text-align:center;z-index:110;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Calendrier détaillé</strong></span></div>
<div id="wb_MaterialIcon29" style="position:absolute;left:655px;top:24px;width:99px;height:79px;text-align:center;z-index:111;">
...
<div id="wb_MaterialIcon32" style="position:absolute;left:670px;top:199px;width:68px;height:80px;text-align:center;z-index:112;">
...
<div id="wb_Text9" style="position:absolute;left:642px;top:123px;width:124px;height:36px;text-align:center;z-index:113;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Gestion des erreurs</strong></span></div>
<div id="wb_Text90" style="position:absolute;left:642px;top:285px;width:124px;height:36px;text-align:center;z-index:114;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Test écran et netteté</strong></span></div>
<div id="wb_MaterialIcon36" style="position:absolute;left:29px;top:361px;width:90px;height:72px;text-align:center;z-index:115;">
<a href="#" onclick="$('#jQueryDialog45').dialog('open');return false;"><div id="MaterialIcon36"><i class="material-icons">&#xe328;</i></div></a></div>
<div id="wb_Text41" style="position:absolute;left:12px;top:453px;width:124px;height:36px;text-align:center;z-index:116;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Vérification mise à jour WebOS</strong></span></div>
<div id="wb_MaterialIcon39" style="position:absolute;left:187px;top:361px;width:90px;height:72px;text-align:center;z-index:117;">
<a href="#" onclick="$('#jQueryDialog92').dialog('open');return false;"><div id="MaterialIcon39"><i class="material-icons">&#xe8ce;</i></div></a></div>
<div id="wb_Text83" style="position:absolute;left:168px;top:453px;width:124px;height:36px;text-align:center;z-index:118;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Registre d'extensions</strong></span></div>
</div>

<div id="jQueryDialog33" style="z-index:554;" title="Test de votre connexion internet">
<div id="wb_MaterialIcon14" style="position:absolute;left:10px;top:11px;width:37px;height:37px;text-align:center;z-index:119;">
...
<div id="wb_Text33" style="position:absolute;left:94px;top:21px;width:639px;height:16px;z-index:120;">
...
<div id="Html19" style="position:absolute;left:18px;top:59px;width:727px;height:354px;z-index:121">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
...
<div id="jQueryDialog41" style="z-index:557;" title="Gestionnaire de Jeux">
<object data="gamemanager.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog20" style="z-index:558;" title="D&#233;part RER SNCF par ville (system/program/sncfappli) [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/sncf.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog16" style="z-index:559;" title="StreetView">
<iframe
  width="100%"
  height="100%"
...
<div id="jQueryDialog12" style="z-index:560;" title="Applications virtualis&#233;es">
<div id="wb_jQueryAccordion1" style="position:absolute;left:9px;top:11px;width:788px;height:430px;z-index:134;">
<div id="jQueryAccordion1">
<h3>Origine Windows</h3>
<div>
<div id="wb_Image8" style="position:absolute;left:3px;top:1px;width:82px;height:82px;z-index:125;">
...
<div id="wb_Image11" style="position:absolute;left:137px;top:1px;width:82px;height:82px;z-index:126;">
...
<div id="wb_Image14" style="position:absolute;left:207px;top:1px;width:80px;height:80px;z-index:127;">
...
<div id="wb_Image9" style="position:absolute;left:71px;top:1px;width:82px;height:82px;z-index:128;">
...
<h3>Origine Linux</h3>
<div>
<div id="wb_Image1" style="position:absolute;left:3px;top:2px;width:85px;height:85px;z-index:129;">
...
<div>
<div id="wb_Image7" style="position:absolute;left:5px;top:4px;width:89px;height:89px;z-index:130;">
<a href="#" onclick="$('#jQueryDialog79').dialog('open');return false;"><img src="images/256x256bb.png" id="Image7" alt=""></a></div>
<div id="wb_Image16" style="position:absolute;left:82px;top:4px;width:89px;height:89px;z-index:131;">
...
<div id="wb_Image17" style="position:absolute;left:155px;top:5px;width:89px;height:89px;z-index:132;">
...
<div>
<div id="wb_Text27" style="position:absolute;left:16px;top:12px;width:717px;height:48px;z-index:133;">
...
<div id="jQueryDialog27" style="z-index:561;" title="Docteur Flashy - Analyse de votre ordinateur">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/doctorflashy.php">
</iframe>
</div>

<div id="jQueryDialog10" style="z-index:562;" title="TChat WebOS (Publique)">
<div id="Html10" style="position:absolute;left:219px;top:16px;width:688px;height:416px;z-index:145">
...
<div id="wb_Image25" style="position:absolute;left:12px;top:16px;width:200px;height:150px;z-index:146;">
<img src="images/deco_pausecafe_tchat.gif" id="Image25" alt=""></div>
<div id="wb_Text39" style="position:absolute;left:14px;top:416px;width:197px;height:16px;text-align:right;z-index:147;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Tchat Version 1.1</span></div>
</div>

<div id="jQueryDialog29" style="z-index:563;" title="AVERTISSEMENT">
<div id="wb_Text6" style="position:absolute;left:13px;top:16px;width:379px;height:273px;text-align:center;z-index:148;">
...
<input type="submit" id="Button6" onclick="$('#jQueryDialog10').dialog('open');$('#jQueryDialog29').dialog('close');return false;" name="" value="J'accepte les conditions" style="position:absolute;left:15px;top:309px;width:374px;height:25px;z-index:149;">
<div id="wb_Text81" style="position:absolute;left:11px;top:343px;width:383px;height:70px;text-align:justify;z-index:150;">
...
<div id="jQueryDialog36" style="z-index:564;" title="Configuration clavier">
<div id="wb_MaterialIcon17" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:151;">
...
<div id="wb_Text35" style="position:absolute;left:73px;top:19px;width:249px;height:16px;z-index:152;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Paramètrage du clavier&nbsp;:</span></div>
<div id="wb_Text36" style="position:absolute;left:14px;top:76px;width:141px;height:16px;z-index:153;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Langue du clavier&nbsp;: </span></div>
<select name="Combobox1" size="1" id="Combobox1" style="position:absolute;left:165px;top:70px;width:176px;height:28px;z-index:154;">
<option selected value="fr-FR">Français (French)</option>
<option value="en-US">Anglais (English)</option>
</select>
<input type="text" id="Editbox1" style="position:absolute;left:10px;top:126px;width:529px;height:16px;line-height:16px;z-index:155;" name="Editbox1" value="Tester votre clavier dans cette zone : " spellcheck="false">
</div>

<div id="jQueryDialog37" style="z-index:565;" title="Configuration de votre interface personnelle">
<div id="jQueryTabs3" style="position:absolute;left:13px;top:13px;width:676px;height:532px;z-index:214;">
<ul>
...
<div id="Html49" style="position:absolute;left:18px;top:21px;width:151px;height:101px;overflow:hidden;z-index:156">
...
<div id="Html52" style="position:absolute;left:179px;top:21px;width:148px;height:101px;overflow:hidden;z-index:157">
...
<div id="Html55" style="position:absolute;left:337px;top:21px;width:153px;height:101px;overflow:hidden;z-index:158">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html50" style="position:absolute;left:499px;top:21px;width:145px;height:101px;overflow:hidden;z-index:159">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html53" style="position:absolute;left:18px;top:133px;width:151px;height:98px;overflow:hidden;z-index:160">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html56" style="position:absolute;left:179px;top:133px;width:148px;height:98px;overflow:hidden;z-index:161">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html51" style="position:absolute;left:337px;top:133px;width:153px;height:98px;overflow:hidden;z-index:162">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html54" style="position:absolute;left:499px;top:133px;width:145px;height:98px;overflow:hidden;z-index:163">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html57" style="position:absolute;left:18px;top:242px;width:151px;height:102px;overflow:hidden;z-index:164">
<!DOCTYPE html>
<html>
<body>
...
<div id="wb_Text38" style="position:absolute;left:17px;top:462px;width:642px;height:16px;z-index:165;">
...
<div id="Html64" style="position:absolute;left:12px;top:14px;width:101px;height:86px;overflow:hidden;z-index:166">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html66" style="position:absolute;left:121px;top:14px;width:101px;height:86px;overflow:hidden;z-index:167">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html67" style="position:absolute;left:228px;top:14px;width:101px;height:86px;overflow:hidden;z-index:168">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html68" style="position:absolute;left:339px;top:14px;width:101px;height:86px;overflow:hidden;z-index:169">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html69" style="position:absolute;left:449px;top:14px;width:101px;height:86px;overflow:hidden;z-index:170">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html70" style="position:absolute;left:561px;top:14px;width:101px;height:86px;overflow:hidden;z-index:171">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html71" style="position:absolute;left:13px;top:113px;width:101px;height:86px;overflow:hidden;z-index:172">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html72" style="position:absolute;left:121px;top:113px;width:101px;height:86px;overflow:hidden;z-index:173">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html73" style="position:absolute;left:228px;top:113px;width:101px;height:86px;overflow:hidden;z-index:174">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html74" style="position:absolute;left:339px;top:113px;width:101px;height:86px;overflow:hidden;z-index:175">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html75" style="position:absolute;left:449px;top:113px;width:101px;height:86px;overflow:hidden;z-index:176">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html76" style="position:absolute;left:561px;top:113px;width:101px;height:86px;overflow:hidden;z-index:177">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html77" style="position:absolute;left:13px;top:214px;width:101px;height:86px;overflow:hidden;z-index:178">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html78" style="position:absolute;left:121px;top:214px;width:101px;height:86px;overflow:hidden;z-index:179">
<!DOCTYPE html>
<html>
<body>
...
<div id="wb_Text69" style="position:absolute;left:19px;top:462px;width:642px;height:16px;z-index:180;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;"><em>Le changement d'un fond d'écran peut prendre quelques secondes en fonction de votre débit internet.</em></span></div>
</div>
<div style="height:510px;" id="jquerytabs3-page-2">
<div id="Html65" style="position:absolute;left:13px;top:14px;width:101px;height:86px;overflow:hidden;z-index:181">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html79" style="position:absolute;left:124px;top:14px;width:101px;height:86px;overflow:hidden;z-index:182">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html80" style="position:absolute;left:232px;top:14px;width:101px;height:86px;overflow:hidden;z-index:183">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html81" style="position:absolute;left:343px;top:14px;width:101px;height:86px;overflow:hidden;z-index:184">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html82" style="position:absolute;left:457px;top:14px;width:101px;height:86px;overflow:hidden;z-index:185">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html83" style="position:absolute;left:566px;top:14px;width:101px;height:86px;overflow:hidden;z-index:186">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html84" style="position:absolute;left:13px;top:111px;width:101px;height:86px;overflow:hidden;z-index:187">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html85" style="position:absolute;left:124px;top:111px;width:101px;height:86px;overflow:hidden;z-index:188">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html86" style="position:absolute;left:232px;top:111px;width:101px;height:86px;overflow:hidden;z-index:189">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html87" style="position:absolute;left:343px;top:111px;width:101px;height:86px;overflow:hidden;z-index:190">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html88" style="position:absolute;left:457px;top:111px;width:101px;height:86px;overflow:hidden;z-index:191">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html89" style="position:absolute;left:566px;top:111px;width:101px;height:86px;overflow:hidden;z-index:192">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html90" style="position:absolute;left:13px;top:206px;width:101px;height:86px;overflow:hidden;z-index:193">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html91" style="position:absolute;left:124px;top:206px;width:101px;height:86px;overflow:hidden;z-index:194">
<!DOCTYPE html>
<html>
<body>
...
<div id="wb_Text78" style="position:absolute;left:19px;top:462px;width:642px;height:16px;z-index:195;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;"><em>Le changement d'un fond d'écran peut prendre quelques secondes en fonction de votre débit internet.</em></span></div>
</div>
<div style="height:510px;" id="jquerytabs3-page-3">
<div id="Html28" style="position:absolute;left:14px;top:14px;width:146px;height:86px;overflow:hidden;z-index:196">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html29" style="position:absolute;left:172px;top:14px;width:146px;height:86px;overflow:hidden;z-index:197">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html60" style="position:absolute;left:334px;top:14px;width:146px;height:86px;overflow:hidden;z-index:198">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html99" style="position:absolute;left:494px;top:14px;width:146px;height:86px;overflow:hidden;z-index:199">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html100" style="position:absolute;left:14px;top:110px;width:146px;height:86px;overflow:hidden;z-index:200">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html101" style="position:absolute;left:174px;top:110px;width:146px;height:86px;overflow:hidden;z-index:201">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html102" style="position:absolute;left:334px;top:110px;width:146px;height:86px;overflow:hidden;z-index:202">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html103" style="position:absolute;left:494px;top:110px;width:146px;height:86px;overflow:hidden;z-index:203">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html104" style="position:absolute;left:14px;top:210px;width:146px;height:86px;overflow:hidden;z-index:204">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html105" style="position:absolute;left:174px;top:210px;width:146px;height:86px;overflow:hidden;z-index:205">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html106" style="position:absolute;left:334px;top:210px;width:146px;height:86px;overflow:hidden;z-index:206">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html107" style="position:absolute;left:494px;top:210px;width:146px;height:86px;overflow:hidden;z-index:207">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html108" style="position:absolute;left:14px;top:308px;width:146px;height:86px;overflow:hidden;z-index:208">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html109" style="position:absolute;left:174px;top:308px;width:146px;height:86px;overflow:hidden;z-index:209">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html110" style="position:absolute;left:334px;top:308px;width:146px;height:86px;overflow:hidden;z-index:210">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html111" style="position:absolute;left:494px;top:308px;width:146px;height:86px;overflow:hidden;z-index:211">
<!DOCTYPE html>
<html>
<body>
...
<div id="Html112" style="position:absolute;left:14px;top:405px;width:146px;height:76px;overflow:hidden;z-index:212">
<!DOCTYPE html>
<html>
<body>
...
<div id="wb_Text79" style="position:absolute;left:242px;top:449px;width:399px;height:32px;z-index:213;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;"><em>Le changement d'un fond d'écran peut prendre quelques secondes en fonction de votre débit internet.</em></span></div>
</div>
</div>
</div>

<div id="jQueryDialog38" style="z-index:566;" title="Calendrier d&#233;taill&#233;">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://www.2017calendrier.fr/">
</iframe><br />
</div>

<div id="jQueryDialog25" style="z-index:567;" title="Calculateur Euro (system/program/eurocalc)">
<object data="addeosapps/calceuro.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog24" style="z-index:568;" title="Horloge interactive (system/program/horloge)">
<object data="addeosapps/horlogeint.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog34" style="z-index:569;" title="Affichage de votre adresse IP [Service non fonctionnel en HTTPS]">
<div id="wb_MaterialIcon15" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:218;">
...
<div id="Html21" style="position:absolute;left:51px;top:10px;width:411px;height:62px;z-index:219">
ADRESSE IP : 
<?
...
?></div>
<div id="wb_Text26" style="position:absolute;left:15px;top:84px;width:453px;height:64px;z-index:220;">
...
<div id="jQueryDialog39" style="z-index:570;" title="Verification de la protection">
<div id="wb_MaterialIcon20" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:221;">
...
<div id="wb_MaterialIcon21" style="position:absolute;left:48px;top:10px;width:106px;height:100px;text-align:center;z-index:222;">
<div id="MaterialIcon21"><i class="material-icons">&#xe32a;</i></div></div>
<div id="wb_Text37" style="position:absolute;left:165px;top:10px;width:538px;height:128px;text-align:justify;z-index:223;">
...
<div id="jQueryDialog40" style="z-index:571;" title="Editeur 3D Tridiv CSS 3 [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/tridiv3d.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog35" style="z-index:572;" title="Supprimer votre compte">
<div id="wb_Text34" style="position:absolute;left:12px;top:61px;width:377px;height:112px;z-index:225;">
...
<div id="wb_MaterialIcon16" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:226;">
...
<div id="jQueryDialog43" style="z-index:573;" title="Cr&#233;ateur d&#39;application WebOS (sans programmer)">
<div id="wb_Text18" style="position:absolute;left:16px;top:19px;width:250px;height:16px;z-index:227;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Préparation en cours...</span></div>
</div>

<div id="jQueryDialog44" style="z-index:574;" title="HITEK - Les meilleurs actualit&#233;s des nouvelles technologies">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://hitek.fr/actualite">
</iframe>
</div>

<div id="jQueryDialog46" style="z-index:575;" title="Explorateur e-book PDF disponibles (commun)">
<object data="bookmanager.php" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog47" style="z-index:576;" title="Biblioth&#232;que gratuite en ligne (e-book)">
<object data="addeosapps/ebook.php" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog48" style="z-index:577;" title="Hebergeur d&#39;Images en ligne (serveur)">
<div id="Html113" style="position:absolute;left:17px;top:19px;width:765px;height:476px;z-index:231">
<object data="uploads/index.php" type="text/html" width="100%" height="100%" style="overflow:auto" ></object></div>
<input type="button" id="Button33" onclick="$('#jQueryDialog67').dialog('open');return false;" name="" value="Ajouter une nouvelle image au dossier (publique)" style="position:absolute;left:20px;top:507px;width:762px;height:25px;z-index:232;">
</div>
...
<div id="jQueryDialog49" style="z-index:581;" title="Fitness (Studio) avec g&#233;olocalisation">
...
<div id="wb_Text47" style="position:absolute;left:11px;top:15px;width:592px;height:48px;z-index:252;">
...
<div id="jQueryTabs4" style="position:absolute;left:10px;top:73px;width:584px;height:398px;z-index:253;">
<ul>
...
<input type="button" id="Button10" onclick="$('#jQueryDialog1').dialog('close');return false;" name="" value="Menu Applicatifs" style="position:absolute;left:11px;top:15px;width:251px;height:25px;z-index:234;">
<input type="button" id="Button11" onclick="$('#jQueryDialog3').dialog('close');return false;" name="" value="Applis installées" style="position:absolute;left:304px;top:15px;width:251px;height:25px;z-index:235;">
<input type="button" id="Button13" onclick="$('#jQueryDialog9').dialog('close');return false;" name="" value="Application Windows" style="position:absolute;left:11px;top:50px;width:251px;height:25px;z-index:236;">
<input type="button" id="Button14" onclick="$('#jQueryDialog13').dialog('close');return false;" name="" value="Messagerie NetCourriel" style="position:absolute;left:304px;top:50px;width:251px;height:25px;z-index:237;">
<input type="button" id="Button16" onclick="$('#jQueryDialog31').dialog('close');return false;" name="" value="Dépôt Applications" style="position:absolute;left:11px;top:87px;width:251px;height:25px;z-index:238;">
<input type="button" id="Button17" onclick="$('#jQueryDialog16').dialog('close');return false;" name="" value="Street View" style="position:absolute;left:304px;top:87px;width:251px;height:25px;z-index:239;">
<input type="button" id="Button18" onclick="$('#jQueryDialog12').dialog('close');return false;" name="" value="Applications virtualisées" style="position:absolute;left:11px;top:124px;width:251px;height:25px;z-index:240;">
<input type="button" id="Button19" onclick="$('#jQueryDialog10').dialog('close');return false;" name="" value="Chat WebOS" style="position:absolute;left:304px;top:124px;width:251px;height:25px;z-index:241;">
<input type="button" id="Button20" onclick="$('#jQueryDialog40').dialog('close');return false;" name="" value="Editeur 3D Tridiv" style="position:absolute;left:11px;top:161px;width:251px;height:25px;z-index:242;">
<input type="button" id="Button21" onclick="$('#jQueryDialog42').dialog('close');return false;" name="" value="Applications d'Entreprise" style="position:absolute;left:304px;top:161px;width:251px;height:25px;z-index:243;">
<input type="button" id="Button22" onclick="$('#jQueryDialog11').dialog('close');return false;" name="" value="Paramètres et Aides" style="position:absolute;left:11px;top:197px;width:251px;height:25px;z-index:244;">
<input type="button" id="Button23" onclick="$('#jQueryDialog41').dialog('close');return false;" name="" value="Gestionnaire de jeux" style="position:absolute;left:304px;top:197px;width:251px;height:25px;z-index:245;">
<input type="button" id="Button24" onclick="$('#jQueryDialog19').dialog('close');return false;" name="" value="Terminal renseignements" style="position:absolute;left:11px;top:235px;width:251px;height:25px;z-index:246;">
<input type="button" id="Button25" onclick="$('#jQueryDialog8').dialog('close');return false;" name="" value="Navigateur Web Qwant" style="position:absolute;left:304px;top:235px;width:251px;height:25px;z-index:247;">
<input type="button" id="Button26" onclick="$('#jQueryDialog5').dialog('close');return false;" name="" value="Explorateur de fichiers" style="position:absolute;left:11px;top:272px;width:251px;height:25px;z-index:248;">
<input type="button" id="Button27" onclick="$('#jQueryDialog21').dialog('close');return false;" name="" value="Fenêtre de Bienvenue" style="position:absolute;left:304px;top:272px;width:251px;height:25px;z-index:249;">
<div id="wb_Text49" style="position:absolute;left:11px;top:329px;width:513px;height:16px;z-index:250;">
...
<div id="wb_JavaScript2" style="position:absolute;left:16px;top:16px;width:555px;height:301px;z-index:251;">
<script>
...
<div id="jQueryDialog53" style="z-index:586;" title="[WIDGET] Notes">
<textarea name="TextArea1" id="TextArea1" style="position:absolute;left:14px;top:11px;width:238px;height:166px;z-index:272;" rows="9" cols="37" spellcheck="false"></textarea>
</div>

<div id="jQueryDialog15" style="z-index:587;" title="[WIDGET] Calendrier">
<input type="text" id="jQueryDatePicker1" style="position:absolute;left:18px;top:6px;width:236px;height:164px;line-height:164px;z-index:273;" name="jQueryDatePicker1" value="" spellcheck="false">
</div>


<div id="jQueryDialog30" style="z-index:589;" title="Concepteur d&#39;application Web (alpha 0.3)">
<input type="submit" id="Button3" onclick="$('#jQueryDialog22').dialog('open');$('#jQueryDialog30').dialog('close');return false;" name="" value="Ouvrir le concepteur d'application Web (version PHP/HTML)" style="position:absolute;left:45px;top:86px;width:404px;height:25px;z-index:274;">
<div id="wb_Text8" style="position:absolute;left:15px;top:17px;width:451px;height:48px;text-align:justify;z-index:275;">
...
<div id="jQueryDialog22" style="z-index:590;" title="Concepteur d&#39;applications Web (version PHP)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="generatiug/generatiugtest.php">
</iframe><br />
</div>

<div id="jQueryDialog54" style="z-index:591;" title="Applis Web Communautaires">
...
<div id="jQueryDialog51" style="z-index:593;" title="Forum Veler Software (d&#233;veloppement Rynna WebOS et divers projets)">
...
<div id="jQueryDialog56" style="z-index:594;" title="Ipiccy - Retouches photos en ligne">
<object data="addeosapps/ipiccy.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog57" style="z-index:595;" title="Le Bon Coin - Ventes et achats en ligne en France">
<object data="addeosapps/leboncoin.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog58" style="z-index:596;" title="Orange TV - toutes vos chaines en ligne (stream)">
<object data="addeosapps/orangetv.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog59" style="z-index:597;" title="PrintFriendly - Votre page web au format PDF imprimable">
<object data="addeosapps/webpdf.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog60" style="z-index:598;" title="01net - Blog, actualit&#233;s et logiciels informatiques et nouvelle technologie [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/01net.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog61" style="z-index:599;" title="CDiscount [NON COMPATIBLE EN HTTPS]">
...
<input type="button" id="Button28" onclick="$('#jQueryDialog6').dialog('close');return false;" name="" value="Annuler et revenir au bureau" style="position:absolute;left:18px;top:58px;width:420px;height:25px;z-index:285;">
<div id="wb_Logout1" style="position:absolute;left:18px;top:18px;width:418px;height:23px;z-index:286;">
...
<div id="jQueryDialog1" style="z-index:602;" title="Menu Applicatifs">
<div id="wb_FontAwesomeIcon2" style="position:absolute;left:12px;top:12px;width:72px;height:64px;text-align:center;z-index:287;">
...
<div id="wb_Text2" style="position:absolute;left:7px;top:84px;width:77px;height:28px;text-align:center;z-index:288;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis générales</span></div>
<div id="wb_FontAwesomeIcon4" style="position:absolute;left:202px;top:14px;width:73px;height:61px;text-align:center;z-index:289;">
...
<div id="wb_FontAwesomeIcon7" style="position:absolute;left:304px;top:15px;width:67px;height:56px;text-align:center;z-index:290;">
...
<div id="wb_FontAwesomeIcon11" style="position:absolute;left:111px;top:132px;width:61px;height:50px;text-align:center;z-index:291;">
...
<div id="wb_FontAwesomeIcon12" style="position:absolute;left:197px;top:132px;width:78px;height:49px;text-align:center;z-index:292;">
...
<div id="wb_Text12" style="position:absolute;left:199px;top:82px;width:76px;height:28px;text-align:center;z-index:293;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Explorateur Fichiers</span></div>
<div id="wb_Text13" style="position:absolute;left:295px;top:84px;width:86px;height:28px;text-align:center;z-index:294;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis de la communautée</span></div>
<div id="wb_Text19" style="position:absolute;left:106px;top:198px;width:70px;height:28px;text-align:center;z-index:295;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis Virtualisées</span></div>
<div id="wb_Text20" style="position:absolute;left:199px;top:198px;width:76px;height:14px;text-align:center;z-index:296;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Street-View</span></div>
<div id="wb_FontAwesomeIcon13" style="position:absolute;left:303px;top:132px;width:69px;height:50px;text-align:center;z-index:297;">
...
<div id="wb_FontAwesomeIcon14" style="position:absolute;left:396px;top:132px;width:71px;height:49px;text-align:center;z-index:298;">
...
<div id="wb_FontAwesomeIcon18" style="position:absolute;left:396px;top:15px;width:70px;height:54px;text-align:center;z-index:299;">
...
<div id="wb_FontAwesomeIcon19" style="position:absolute;left:109px;top:15px;width:64px;height:56px;text-align:center;z-index:300;">
...
<div id="wb_Text21" style="position:absolute;left:302px;top:198px;width:70px;height:28px;text-align:center;z-index:301;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Messagerie Net-C</span></div>
<div id="wb_Text24" style="position:absolute;left:402px;top:198px;width:65px;height:28px;text-align:center;z-index:302;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Navigateur internet</span></div>
<div id="wb_Text25" style="position:absolute;left:393px;top:84px;width:77px;height:28px;text-align:center;z-index:303;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Paramètres &amp; Aides</span></div>
<div id="wb_Text52" style="position:absolute;left:103px;top:85px;width:73px;height:14px;text-align:center;z-index:304;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Rynna Search</span></div>
<div id="wb_JavaScript3" style="position:absolute;left:320px;top:378px;width:147px;height:23px;z-index:305;">
...
<hr id="Line1" style="position:absolute;left:15px;top:366px;width:452px;z-index:306;">
<div id="wb_LoginName1" style="position:absolute;left:17px;top:378px;width:278px;height:23px;z-index:307;">
...
?> !</span></div>
<div id="wb_FontAwesomeIcon3" style="position:absolute;left:16px;top:245px;width:69px;height:59px;text-align:center;z-index:308;">
...
<div id="wb_Text15" style="position:absolute;left:14px;top:315px;width:75px;height:28px;text-align:center;z-index:309;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Modifier fonds d'écran</span></div>
<div id="wb_MaterialIcon26" style="position:absolute;left:15px;top:132px;width:70px;height:59px;text-align:center;z-index:310;">
...
<div id="wb_Text28" style="position:absolute;left:16px;top:198px;width:64px;height:28px;text-align:center;z-index:311;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Gestionnaire Serveur</span></div>
</div>

<div id="jQueryDialog21" title="Oups !">
<div id="wb_Text103" style="position:absolute;left:15px;top:19px;width:438px;height:112px;z-index:312;">
...
<div id="wb_Text89" style="position:absolute;left:9px;top:12px;width:364px;height:48px;text-align:justify;z-index:323;">
...
<input type="button" id="Button29" onclick="$('#jQueryDialog18').dialog('close');return false;" name="" value="NON" style="position:absolute;left:35px;top:81px;width:96px;height:25px;z-index:324;">
<input type="submit" id="Button30" onclick="window.location.href='./modifuser.php';return false;" name="" value="OUI" style="position:absolute;left:272px;top:81px;width:96px;height:25px;z-index:325;">
</div>

<div id="jQueryDialog2" style="z-index:605;" title="Gestion des erreurs (Kernel PHP)">
<div id="wb_MaterialIcon55" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:326;">
...
<div id="wb_Text91" style="position:absolute;left:73px;top:19px;width:347px;height:16px;z-index:327;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Listes des erreurs gérées par le WebOS&nbsp;:</span></div>
<table style="position:absolute;left:23px;top:57px;width:401px;height:350px;z-index:328;" id="Table1">
<tr>
...
<input type="button" id="Button1" onclick="ShowObject('wb_PageHeader', 0);TimerStartTimer8();return false;" name="" value="Cliquez ici pour ouvrir le Gestionnaire de Tâches" style="position:absolute;left:23px;top:415px;width:401px;height:25px;z-index:329;">
</div>

<div id="jQueryDialog26" style="z-index:606;" title="Maintenance">
<div id="wb_MaterialIcon56" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:330;">
...
<div id="wb_Text92" style="position:absolute;left:73px;top:19px;width:347px;height:112px;z-index:331;">
...
<input type="button" id="Button46" onclick="$('#jQueryDialog77').dialog('open');return false;" name="" value="Afficher le testeur" style="position:absolute;left:33px;top:159px;width:387px;height:25px;z-index:332;">
</div>

<div id="jQueryDialog64" style="z-index:607;" title="Simulateur Smartphone (0.5)">
<input type="button" id="Button31" onclick="$('#jQueryDialog65').dialog('open');$('#jQueryDialog64').dialog('close');return false;" name="" value="Simulateur iPhone X" style="position:absolute;left:20px;top:28px;width:317px;height:25px;z-index:333;">
<input type="button" id="Button32" onclick="$('#jQueryDialog66').dialog('open');$('#jQueryDialog64').dialog('close');return false;" name="" value="Simulateur Samsung Galaxy s8" style="position:absolute;left:20px;top:68px;width:317px;height:25px;z-index:334;">
</div>

<div id="jQueryDialog65" style="z-index:608;" title="Simulateur iPhone X (test de sites Web et WebApps)">
<div id="Layer30" style="position:absolute;text-align:left;left:59px;top:42px;width:253px;height:40px;z-index:335;">
</div>
<div id="wb_Image40" style="position:absolute;left:31px;top:25px;width:307px;height:616px;z-index:336;">
<img src="images/nue_iphone8_design_final_2018.png" id="Image40" alt=""></div>
<div id="Html18" style="position:absolute;left:51px;top:42px;width:268px;height:582px;overflow:hidden;z-index:337">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/mobiledemo.php">
</iframe></div>
<div id="wb_Image41" style="position:absolute;left:101px;top:42px;width:178px;height:29px;z-index:338;">
<img src="images/iphone8_simulation_haut.png" id="Image41" alt=""></div>
<input type="button" id="Button36" onclick="window.confirm('iOS 11');return false;" name="" value="Version iOS" style="position:absolute;left:352px;top:42px;width:222px;height:25px;z-index:339;">
<input type="button" id="Button37" onclick="$('#jQueryDialog64').dialog('open');$('#jQueryDialog65').dialog('close');return false;" name="" value="Retour Simuateur" style="position:absolute;left:354px;top:616px;width:222px;height:25px;z-index:340;">
<div id="wb_Text97" style="position:absolute;left:-1px;top:6px;width:474px;height:15px;z-index:341;">
...
<div id="jQueryDialog66" style="z-index:609;" title="Simulateur Samsung Galaxy s8 (test de sites Web et WebApps)">
<div id="wb_Image42" style="position:absolute;left:55px;top:16px;width:301px;height:642px;z-index:342;">
<img src="images/Samsung-Galaxy-S8-0.png" id="Image42" alt=""></div>
<div id="Html20" style="position:absolute;left:70px;top:57px;width:270px;height:563px;overflow:hidden;z-index:343">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/mobiledemo.php">
</iframe></div>
<input type="button" id="Button38" name="" value="Action bouton central (sous écran)" style="position:absolute;left:366px;top:42px;width:222px;height:25px;z-index:344;">
<input type="button" id="Button41" onclick="window.confirm('Android 7.0');return false;" name="" value="Version Android" style="position:absolute;left:366px;top:90px;width:222px;height:25px;z-index:345;">
<input type="button" id="Button42" onclick="$('#jQueryDialog64').dialog('open');$('#jQueryDialog66').dialog('close');return false;" name="" value="Retour Simuateur" style="position:absolute;left:370px;top:627px;width:222px;height:25px;z-index:346;">
<div id="wb_Text98" style="position:absolute;left:8px;top:6px;width:474px;height:15px;z-index:347;">
<span style="color:#000000;font-family:Arial;font-size:12px;">Simulateur Smartphone conçu par AlgoStep Company - service gratuit</span></div>
</div>

<div id="jQueryDialog67" style="z-index:610;" title="Envoi rapide">
<div id="wb_Extension1" style="position:absolute;left:21px;top:66px;width:845px;height:212px;z-index:348;">
<div id="Extension1">
...
<div id="wb_Text100" style="position:absolute;left:27px;top:13px;width:832px;height:32px;z-index:349;">
...
<div id="jQueryDialog13" style="z-index:611;" title="Messagerie personelle Europ&#233;enne (Net Courriel)">
<object data="addeosapps/messagerienetc.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>


<div id="jQueryDialog69" style="z-index:613;" title="[WIDGET] Horloge">
...
<div id="jQueryDialog70" style="z-index:615;" title="Webcam">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/webcam.php">
</iframe><br />
</div>

<div id="jQueryDialog71" style="z-index:616;" title="Calendrier g&#233;n&#233;ral">
<object data="addeosapps/agenda.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog72" style="z-index:617;" title="Devises">
<object data="addeosapps/devise.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog73" style="z-index:618;" title="Sauvegarde local de votre session">
<div id="Html58" style="position:absolute;left:13px;top:11px;width:336px;height:175px;z-index:360">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="zipaction.php">
</iframe><br /></div>
</div>
...
<div id="jQueryDialog32" style="z-index:620;" title="Informations sur le WebOS">
<div id="wb_Text32" style="position:absolute;left:27px;top:68px;width:714px;height:451px;text-align:center;z-index:369;">
...
<div id="wb_MaterialIcon13" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:370;">
...
<div id="jQueryDialog52" style="z-index:621;" title="Choisir un Widget ?">
...
<div id="wb_MaterialIcon35" style="position:absolute;left:94px;top:108px;width:67px;height:63px;text-align:center;z-index:380;">
...
<div id="wb_Text82" style="position:absolute;left:94px;top:181px;width:67px;height:14px;text-align:center;z-index:381;">
...
<div id="jQueryDialog77" style="z-index:635;" title="Testeur et Afficheur (screen test quality)">
...
<div id="jQueryDialog78" style="z-index:637;" title="Sticky-Notes Generator (WebesTools)">
...
<div id="wb_Text108" style="position:absolute;left:12px;top:13px;width:540px;height:195px;z-index:498;">
...
<div id="jQueryDialog84" style="z-index:645;" title="Links-Dialog">
<object data="sitemap.xml" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog85" style="z-index:646;" title="[SOUND-HELP-MALENTENDANT]-ConfigurationScriptsDialog">
...
<div id="jQueryDialog86" style="z-index:647;" title="Audio-Help">
...
<div id="jQueryDialog87" style="z-index:648;" title="Liligo - Voyages Hotel, Voitures, S&#233;jours [NON COMPATIBLE EN HTTPS]">
...
<div id="jQueryDialog45" style="z-index:651;" title="V&#233;rification des mises &#224; jour WebOS">
...
<span style="color:#FF6347;font-family:Arial;font-size:21px;"><strong>33.0</strong></span></div>
...
<div id="wb_Text76" style="position:absolute;left:17px;top:257px;width:847px;height:32px;z-index:526;">
...
<div id="jQueryDialog42" style="z-index:652;" title="[WIDGET] Biblioth&#232;que">
...
<input type="button" id="Button49" onclick="$('#jQueryDialog47').dialog('open');return false;" name="" value="Télécharger de nouveau e-book" style="position:absolute;left:28px;top:60px;width:215px;height:25px;z-index:529;">
...
<div id="jQueryDialog88" style="z-index:655;" title="Annonce g&#233;n&#233;rale (Administrateur)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
...
<div id="jQueryDialog89" style="z-index:659;" title="Informations sur votre session">
...
<div id="jQueryDialog90" style="z-index:660;" title="Cloud gratuit (15Go) - 4Sync">
<object data="addeosapps/4sync.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog91" style="z-index:661;" title="[WIDGET] Multi-session">
...
<div id="jQueryDialog92" style="z-index:662;" title="Registre des extensions WebOS (Consultation)">
...
<div id="jQueryDialog93" style="z-index:673;" title="Stellarium - Ciel r&#233;aliste en 3D">
...
<div class="clearfix visible-col1"></div>
<div class="blogitem">
   <span class="blogsubject">Version 32.1</span>
   <div class="no-thumb"></div>
   <div class="blogdate">15/02/18<br></div>
   <span style="color:#000000;">- Intégration du registre des extensions prises en charges par le WebOS</span><br>
   <div class="blogcomments"></div>
</div>
<div class="clearfix visible-col1"></div>
<div class="blogitem">
...
<div id="Layer6" style="position:absolute;text-align:left;left:247px;top:88px;width:527px;height:371px;z-index:321;">
</div>
<div id="Layer35" style="position:absolute;text-align:left;left:142px;top:518px;width:761px;height:136px;z-index:322;">
<div id="wb_Text40" style="position:absolute;left:48px;top:30px;width:664px;height:67px;text-align:center;z-index:318;">
...
<div id="wb_FontAwesomeIcon21" style="position:absolute;left:25px;top:16px;width:78px;height:63px;text-align:center;z-index:352;">
<a href="#" onclick="$('#jQueryDialog70').dialog('open');return false;"><div id="FontAwesomeIcon21"><i class="fa fa-camera">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon22" style="position:absolute;left:25px;top:118px;width:78px;height:68px;text-align:center;z-index:353;">
<a href="#" onclick="$('#jQueryDialog72').dialog('open');return false;"><div id="FontAwesomeIcon22"><i class="fa fa-euro">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon24" style="position:absolute;left:25px;top:325px;width:78px;height:70px;text-align:center;z-index:354;">
...
<div id="wb_FontAwesomeIcon25" style="position:absolute;left:25px;top:435px;width:78px;height:64px;text-align:center;z-index:355;">
<a href="#" onclick="$('#jQueryDialog73').dialog('open');return false;"><div id="FontAwesomeIcon25"><i class="fa fa-save">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon23" style="position:absolute;left:25px;top:227px;width:78px;height:61px;text-align:center;z-index:356;">
...
<div id="Layer8" style="position:absolute;text-align:left;left:150px;top:82px;width:855px;height:460px;z-index:364;">
<div id="Layer9" style="position:absolute;text-align:left;left:16px;top:11px;width:218px;height:436px;z-index:361;" onclick="$('#jQueryDialog3').dialog('open');ShowObject('Layer7', 0);return false;">
</div>
<div id="Layer10" style="position:absolute;text-align:left;left:236px;top:11px;width:211px;height:436px;z-index:362;" onclick="$('#jQueryDialog5').dialog('open');ShowObject('Layer7', 0);return false;">
</div>
<div id="Layer11" style="position:absolute;text-align:left;left:453px;top:11px;width:373px;height:436px;z-index:363;" onclick="$('#jQueryDialog11').dialog('open');ShowObject('Layer7', 0);return false;">
</div>
</div>
<script>
var wb_Timer9;
...
<div id="Layer22" style="position:absolute;text-align:left;left:348px;top:5969px;width:1099px;height:152px;z-index:679;" onmouseleave="ShowObject('Layer22', 0);return false;">
<div id="wb_Image43" style="position:absolute;left:89px;top:39px;width:915px;height:100px;z-index:382;">
<img src="images/coque_sfx_3D.png" id="Image43" alt=""></div>
<div id="wb_Image51" style="position:absolute;left:732px;top:30px;width:80px;height:80px;z-index:383;">
...
<div id="wb_Image46" style="position:absolute;left:508px;top:17px;width:110px;height:110px;z-index:384;">
...
<div id="wb_Image47" style="position:absolute;left:386px;top:17px;width:110px;height:110px;z-index:385;">
...
<div id="wb_Image48" style="position:absolute;left:272px;top:17px;width:110px;height:110px;z-index:386;">
...
<div id="wb_Image49" style="position:absolute;left:153px;top:17px;width:110px;height:110px;z-index:387;">
...
<div id="wb_Image50" style="position:absolute;left:626px;top:30px;width:80px;height:80px;z-index:388;">
...
<div id="wb_Image52" style="position:absolute;left:838px;top:30px;width:80px;height:80px;z-index:389;">
...
<div id="Layer23" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:680;" onclick="ShowObject('Layer23', 0);return false;">
<script>
var wb_Timer42;
...
<div id="Layer24" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:681;">
<div id="Layer2" style="position:absolute;text-align:left;left:198px;top:25px;width:511px;height:363px;z-index:400;">
</div>
<div id="Layer25" style="position:absolute;text-align:left;left:50px;top:432px;width:801px;height:74px;z-index:401;">
<div id="wb_Text5" style="position:absolute;left:29px;top:14px;width:739px;height:39px;text-align:center;z-index:399;">
...
<div id="Layer31" style="position:fixed;text-align:left;left:0px;top:0px;width:46px;height:41px;z-index:402;">
</div>
<div id="Layer32" style="position:fixed;text-align:left;left:auto;right:0px;top:0px;width:46px;height:41px;z-index:403;">
</div>
<div id="Layer33" style="position:fixed;text-align:left;left:auto;right:0px;top:auto;bottom:0px;width:46px;height:41px;z-index:404;">
</div>
<div id="Layer34" style="position:fixed;text-align:left;left:0px;top:auto;bottom:0px;width:46px;height:41px;z-index:405;">
</div>
</div>
<div id="Layer26" style="position:absolute;text-align:left;left:2533px;top:721px;width:182px;height:214px;z-index:682;">
<div id="wb_Text17" style="position:absolute;left:8px;top:8px;width:163px;height:15px;z-index:407;">
...
<hr id="Line2" style="position:absolute;left:7px;top:35px;width:164px;z-index:408;">
<div id="wb_Text22" style="position:absolute;left:8px;top:59px;width:163px;height:16px;z-index:409;cursor: pointer;" onclick="$('#jQueryDialog89').dialog('open');$('#jQueryDialog37').dialog('open');ShowObject('Layer26', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Changer fond écran</span></div>
<div id="wb_Text48" style="position:absolute;left:7px;top:88px;width:163px;height:16px;z-index:410;cursor: pointer;" onclick="ShowObject('Layer22', 1);ShowObject('Layer26', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Afficher la BottomBar</span></div>
<div id="wb_Text51" style="position:absolute;left:7px;top:116px;width:163px;height:16px;z-index:411;cursor: pointer;" onclick="$('#jQueryDialog5').dialog('open');ShowObject('Layer26', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Ouvrir l'explorateur</span></div>
<hr id="Line3" style="position:absolute;left:9px;top:143px;width:164px;z-index:412;">
<div id="wb_Text66" style="position:absolute;left:8px;top:167px;width:163px;height:16px;z-index:413;cursor: pointer;" onclick="$('#jQueryDialog17').dialog('open');ShowObject('Layer26', 0);return false;">
<span style="color:#FFA500;font-family:Arial;font-size:13px;">Réparer la session</span></div>
</div>
<div id="Layer27" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:683;">
<script>
var wb_Timer44;
