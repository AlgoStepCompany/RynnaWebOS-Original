...
<div id="Layer21" style="position:fixed;text-align:left;left:0;right:0;bottom:0;height:15px;z-index:555;" onmouseenter="ShowObject('Layer22', 1);AnimateCss('Layer22', 'animate-fade-in', 5, 500);return false;">
</div>
<div id="Layer1" style="position:absolute;text-align:center;left:2202px;top:1387px;width:755px;height:436px;z-index:556;">
...
<div id="jQueryDialog3" style="z-index:564;" title="Mes applications install&#233;es (Applis G&#233;n&#233;rales)">
...
<div id="jQueryDialog4" style="z-index:565;" title="Calculatrice (system/program/calculatrice)">
<object data="addeosapps/calc.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog5" style="z-index:566;" title="Explorateur de fichiers - Votre espace personnel (50 Go maximum)">
...
<div id="jQueryDialog8" style="z-index:567;" title="Navigateur web StartPage (all&#233;g&#233;, sans onglet) [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/navigateur.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog14" style="z-index:568;" title="Editeur de texte (FullPro CK Series 2016)">
<object data="system/program/texteditor/editor.html" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog19" style="z-index:569;" title="Rynna Search (Rechercher une page du WebOS)">
...
<div id="jQueryDialog23" style="z-index:570;" title="Jeu de Hasard (system/program/dee)">
<object data="addeosapps/deeint.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog28" style="z-index:571;" title="WordPad - Editeur de texte avanc&#233;">
<object data="addeosapps/wordpad.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog7" style="z-index:572;" title="Informations sur votre location - M&#233;t&#233;o temps r&#233;el [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/meteo.php" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>



<div id="jQueryDialog11" style="z-index:575;" title="Param&#232;tres et aides suppl&#233;mentaires">
...
<div id="jQueryDialog33" style="z-index:576;" title="Test de votre connexion internet">
...
<div id="jQueryDialog41" style="z-index:579;" title="Gestionnaire de Jeux">
<object data="gamemanager.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog20" style="z-index:580;" title="D&#233;part RER SNCF par ville (system/program/sncfappli) [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/sncf.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog16" style="z-index:581;" title="StreetView">
<iframe
  width="100%"
  height="100%"
...
<div id="jQueryDialog12" style="z-index:582;" title="Applications virtualis&#233;es">
...
<div id="jQueryDialog27" style="z-index:583;" title="Docteur Flashy - Analyse de votre ordinateur">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/doctorflashy.php">
</iframe>
</div>

<div id="jQueryDialog10" style="z-index:584;" title="TChat WebOS (Publique)">
...
<div id="jQueryDialog29" style="z-index:585;" title="AVERTISSEMENT">
...
<div id="jQueryDialog36" style="z-index:586;" title="Configuration clavier">
...
<div id="jQueryDialog37" style="z-index:587;" title="Configuration de votre interface personnelle">
...
<div id="jQueryDialog38" style="z-index:588;" title="Calendrier d&#233;taill&#233;">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://www.2017calendrier.fr/">
</iframe><br />
</div>

<div id="jQueryDialog25" style="z-index:589;" title="Calculateur Euro (system/program/eurocalc)">
<object data="addeosapps/calceuro.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog24" style="z-index:590;" title="Horloge interactive (system/program/horloge)">
<object data="addeosapps/horlogeint.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog34" style="z-index:591;" title="Affichage de votre adresse IP [Service non fonctionnel en HTTPS]">
...
<div id="jQueryDialog39" style="z-index:592;" title="Verification de la protection">
...
<div id="jQueryDialog40" style="z-index:593;" title="Editeur 3D Tridiv CSS 3 [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/tridiv3d.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog35" style="z-index:594;" title="Supprimer votre compte">
...
<div id="jQueryDialog43" style="z-index:595;" title="Cr&#233;ateur d&#39;application WebOS (sans programmer)">
...
<div id="jQueryDialog44" style="z-index:596;" title="HITEK - Les meilleurs actualit&#233;s des nouvelles technologies">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://hitek.fr/actualite">
</iframe>
</div>

<div id="jQueryDialog46" style="z-index:597;" title="Explorateur e-book PDF disponibles (commun)">
<object data="bookmanager.php" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog47" style="z-index:598;" title="Biblioth&#232;que gratuite en ligne (e-book)">
<object data="addeosapps/ebook.php" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog48" style="z-index:599;" title="Hebergeur d&#39;Images en ligne (serveur)">
...
<div id="jQueryDialog49" style="z-index:603;" title="Fitness (Studio) avec g&#233;olocalisation">
...
<div id="jQueryDialog53" style="z-index:608;" title="[WIDGET] Notes">
...
<div id="jQueryDialog15" style="z-index:609;" title="[WIDGET] Calendrier">
...
<div id="jQueryDialog30" style="z-index:611;" title="Concepteur d&#39;application Web (alpha 0.3)">
...
<div id="jQueryDialog22" style="z-index:612;" title="Concepteur d&#39;applications Web (version PHP)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="generatiug/generatiugtest.php">
</iframe><br />
</div>

<div id="jQueryDialog54" style="z-index:613;" title="Applis Web Communautaires">
...
<div id="jQueryDialog51" style="z-index:615;" title="Forum Veler Software (d&#233;veloppement Rynna WebOS et divers projets)">
...
<div id="jQueryDialog56" style="z-index:616;" title="Ipiccy - Retouches photos en ligne">
<object data="addeosapps/ipiccy.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog57" style="z-index:617;" title="Le Bon Coin - Ventes et achats en ligne en France">
<object data="addeosapps/leboncoin.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog58" style="z-index:618;" title="Orange TV - toutes vos chaines en ligne (stream)">
<object data="addeosapps/orangetv.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog59" style="z-index:619;" title="PrintFriendly - Votre page web au format PDF imprimable">
<object data="addeosapps/webpdf.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog60" style="z-index:620;" title="01net - Blog, actualit&#233;s et logiciels informatiques et nouvelle technologie [NON COMPATIBLE EN HTTPS]">
<object data="addeosapps/01net.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog61" style="z-index:621;" title="CDiscount [NON COMPATIBLE EN HTTPS]">
...
<div id="Layer3" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:623;" onclick="ShowObject('Layer3', 0);return false;">
<script>
var wb_Timer5;
...
<div id="jQueryDialog2" style="z-index:625;" title="Gestion des erreurs (Kernel PHP)">
...
<div id="jQueryDialog26" style="z-index:626;" title="Maintenance">
...
<div id="jQueryDialog64" style="z-index:627;" title="Simulateur Smartphone (0.5)">
...
<div id="jQueryDialog65" style="z-index:628;" title="Simulateur iPhone X (test de sites Web et WebApps)">
...
<div id="jQueryDialog66" style="z-index:629;" title="Simulateur Samsung Galaxy s8 (test de sites Web et WebApps)">
...
<div id="jQueryDialog67" style="z-index:630;" title="Envoi rapide">
...
<div id="jQueryDialog13" style="z-index:631;" title="Messagerie personelle Europ&#233;enne (Net Courriel)">
<object data="addeosapps/messagerienetc.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>


<div id="jQueryDialog69" style="z-index:633;" title="[WIDGET] Horloge">
...
<div id="jQueryDialog70" style="z-index:635;" title="Webcam">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/webcam.php">
</iframe><br />
</div>

<div id="jQueryDialog71" style="z-index:636;" title="Calendrier g&#233;n&#233;ral">
<object data="addeosapps/agenda.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog72" style="z-index:637;" title="Devises">
<object data="addeosapps/devise.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog73" style="z-index:638;" title="Sauvegarde local de votre session">
...
<div id="jQueryDialog32" style="z-index:641;" title="Informations sur le WebOS">
...
<div id="Layer22" style="position:absolute;text-align:left;left:348px;top:5969px;width:1099px;height:152px;z-index:643;" onmouseleave="ShowObject('Layer22', 0);return false;">
...
<div id="jQueryDialog9" style="z-index:645;" title="Wikip&#233;dia">
<object data="addeosapps/wikipedia.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog31" style="z-index:646;" title="Le Monde - Actualit&#233;s de France">
<object data="addeosapps/lemonde.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog55" style="z-index:647;" title="Forum Etienne BAUDOUX - Forum li&#233; au projet Rynna WebOS">
<object data="addeosapps/sz.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog68" style="z-index:648;" title="OpenClassRoom - Tutoriels et cours en ligne">
<object data="addeosapps/ocr.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog75" style="z-index:649;" title="SUMO PAINT - Dessin (demonstration gratuite)">
<object data="addeosapps/paint.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog76" style="z-index:650;" title="Now-Coworking - Espace Coworking pour votre Entreprise">
<object data="addeosapps/nowcoworking.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog62" style="z-index:651;" title="Notes dropbox - FARGO (gratuit)">
<object data="addeosapps/fargo.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="Layer23" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:652;" onclick="ShowObject('Layer23', 0);return false;">
<script>
var wb_Timer42;
...
<div id="Layer24" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:653;">
<div id="Layer2" style="position:absolute;text-align:left;left:198px;top:25px;width:511px;height:363px;z-index:354;">
</div>
<div id="Layer25" style="position:absolute;text-align:left;left:50px;top:432px;width:801px;height:74px;z-index:355;">
<div id="wb_Text5" style="position:absolute;left:29px;top:14px;width:739px;height:39px;text-align:center;z-index:353;">
...
<div id="Layer31" style="position:fixed;text-align:left;left:0px;top:0px;width:46px;height:41px;z-index:356;">
</div>
<div id="Layer32" style="position:fixed;text-align:left;left:auto;right:0px;top:0px;width:46px;height:41px;z-index:357;">
</div>
<div id="Layer33" style="position:fixed;text-align:left;left:auto;right:0px;top:auto;bottom:0px;width:46px;height:41px;z-index:358;">
</div>
<div id="Layer34" style="position:fixed;text-align:left;left:0px;top:auto;bottom:0px;width:46px;height:41px;z-index:359;">
</div>
</div>
<script>
var wb_Timer4;
...
<div id="Layer26" style="position:fixed;text-align:left;left:0px;top:auto;bottom:0px;width:182px;height:214px;z-index:655;">
<div id="wb_Text17" style="position:absolute;left:8px;top:8px;width:163px;height:15px;z-index:361;">
...
<hr id="Line2" style="position:absolute;left:7px;top:35px;width:164px;z-index:362;">
<div id="wb_Text22" style="position:absolute;left:8px;top:59px;width:163px;height:16px;z-index:363;cursor: pointer;" onclick="$('#jQueryDialog89').dialog('open');$('#jQueryDialog37').dialog('open');ShowObject('Layer26', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Changer fond écran</span></div>
<div id="wb_Text48" style="position:absolute;left:7px;top:88px;width:163px;height:16px;z-index:364;cursor: pointer;" onclick="ShowObject('Layer22', 1);ShowObject('Layer26', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Afficher la BottomBar</span></div>
<div id="wb_Text51" style="position:absolute;left:7px;top:116px;width:163px;height:16px;z-index:365;cursor: pointer;" onclick="$('#jQueryDialog5').dialog('open');ShowObject('Layer26', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Ouvrir l'explorateur</span></div>
<hr id="Line3" style="position:absolute;left:9px;top:143px;width:164px;z-index:366;">
<div id="wb_Text66" style="position:absolute;left:8px;top:167px;width:163px;height:16px;z-index:367;cursor: pointer;" onclick="$('#jQueryDialog17').dialog('open');ShowObject('Layer26', 0);return false;">
...
<div id="Layer27" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:657;">
<script>
var wb_Timer44;
...
<div id="Layer29" style="position:absolute;text-align:left;left:135px;top:423px;width:706px;height:104px;z-index:371;">
<div id="wb_Text70" style="position:absolute;left:24px;top:28px;width:659px;height:46px;text-align:center;z-index:368;">
...
<div id="Layer28" style="position:absolute;text-align:left;left:232px;top:49px;width:529px;height:374px;z-index:373;">
</div>
<script>
var wb_Timer47;
...
<div id="wb_Text71" style="position:absolute;left:7px;top:13px;width:454px;height:240px;z-index:376;">
...
<input type="button" id="Button2" onclick="ShowObject('Layer27', 1);$('#jQueryDialog17').dialog('close');TimerStartTimer45();return false;" name="" value="Réparer maintenant" style="position:absolute;left:14px;top:276px;width:166px;height:25px;z-index:377;">
<input type="button" id="Button4" onclick="$('#jQueryDialog17').dialog('close');return false;" name="" value="Annuler" style="position:absolute;left:299px;top:276px;width:166px;height:25px;z-index:378;">
</div>

<div id="jQueryDialog63" title="Proc&#233;dure de r&#233;paration">
<div id="wb_Text72" style="position:absolute;left:111px;top:11px;width:379px;height:80px;z-index:379;">
...
<input type="button" id="Button7" onclick="$('#jQueryDialog63').dialog('close');return false;" name="" value="Fermer" style="position:absolute;left:186px;top:112px;width:129px;height:25px;z-index:380;">
<div id="wb_FontAwesomeIcon5" style="position:absolute;left:8px;top:11px;width:95px;height:80px;text-align:center;z-index:381;">
<div id="FontAwesomeIcon5"><i class="fa fa-shield">&nbsp;</i></div></div>
</div>

<div id="jQueryDialog77" style="z-index:660;" title="Testeur et Afficheur (screen test quality)">
<div id="wb_Image26" style="position:absolute;left:18px;top:15px;width:540px;height:540px;z-index:382;">
<img src="images/test_pixel_ecran.gif" id="Image26" alt=""></div>
<div id="wb_Image27" style="position:absolute;left:556px;top:15px;width:274px;height:274px;z-index:383;">
<img src="images/test_pixel_ecran.gif" id="Image27" alt=""></div>
<div id="wb_Image29" style="position:absolute;left:556px;top:289px;width:142px;height:142px;z-index:384;">
<img src="images/test_pixel_ecran.gif" id="Image29" alt=""></div>
<div id="wb_Image30" style="position:absolute;left:698px;top:289px;width:142px;height:142px;z-index:385;">
<img src="images/test_pixel_ecran.gif" id="Image30" alt=""></div>
<div id="wb_Image31" style="position:absolute;left:838px;top:289px;width:142px;height:142px;z-index:386;">
<img src="images/test_pixel_ecran.gif" id="Image31" alt=""></div>
<div id="wb_Image44" style="position:absolute;left:975px;top:289px;width:131px;height:142px;z-index:387;">
<img src="images/test_pixel_ecran.gif" id="Image44" alt=""></div>
<div id="wb_Image56" style="position:absolute;left:556px;top:431px;width:550px;height:124px;z-index:388;">
<img src="images/test_pixel_ecran.gif" id="Image56" alt=""></div>
<div id="wb_Image28" style="position:absolute;left:832px;top:15px;width:274px;height:274px;z-index:389;">
<img src="images/test_pixel_ecran.gif" id="Image28" alt=""></div>
</div>


<div id="jQueryDialog78" style="z-index:662;" title="Sticky-Notes Generator (WebesTools)">
...
<div id="jQueryDialog83" style="z-index:667;" title="Gestionnaire de Serveur">
<input type="button" id="Button5" onclick="$('#jQueryDialog83').dialog('close');return false;" name="" value="Fermer" style="position:absolute;left:327px;top:176px;width:161px;height:25px;z-index:456;">
<div id="wb_Text44" style="position:absolute;left:13px;top:17px;width:473px;height:16px;z-index:457;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Links-Dialog (sitemap public)</span></div>
<div id="wb_Text50" style="position:absolute;left:13px;top:93px;width:473px;height:16px;z-index:458;">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Aides Audio (descriptif audio des fonctions du WebOS)</span></div>
<div id="wb_FontAwesomeIcon6" style="position:absolute;left:14px;top:33px;width:470px;height:42px;text-align:center;z-index:459;">
<a href="#" onclick="$('#jQueryDialog84').dialog('open');return false;"><div id="FontAwesomeIcon6"><i class="fa fa-anchor">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon8" style="position:absolute;left:14px;top:109px;width:470px;height:42px;text-align:center;z-index:460;">
...
<div id="jQueryDialog84" style="z-index:668;" title="Links-Dialog">
<object data="sitemap.xml" type="text/html" width="100%" height="100%" style="overflow:auto" ></object>
</div>

<div id="jQueryDialog85" style="z-index:669;" title="[SOUND-HELP-MALENTENDANT]-ConfigurationScriptsDialog">
<div id="wb_MediaPlayer1" style="position:absolute;left:22px;top:76px;width:67px;height:55px;z-index:462;">
<audio src="001.wav" id="MediaPlayer1">
</audio>
</div>
<div id="wb_Text74" style="position:absolute;left:10px;top:20px;width:959px;height:32px;z-index:463;">
...
<div id="wb_MediaPlayer2" style="position:absolute;left:96px;top:76px;width:67px;height:55px;z-index:464;">
<audio src="explorateurfichiers.wav" id="MediaPlayer2">
</audio>
</div>
<div id="wb_MediaPlayer3" style="position:absolute;left:174px;top:76px;width:67px;height:55px;z-index:465;">
<audio src="applisinternes.wav" id="MediaPlayer3">
</audio>
</div>
<div id="wb_MediaPlayer4" style="position:absolute;left:254px;top:76px;width:67px;height:55px;z-index:466;">
<audio src="bienvenue.wav" id="MediaPlayer4">
</audio>
</div>
<div id="wb_MediaPlayer5" style="position:absolute;left:332px;top:76px;width:67px;height:55px;z-index:467;">
<audio src="parametres.wav" id="MediaPlayer5">
</audio>
</div>
</div>

<div id="jQueryDialog86" style="z-index:670;" title="Audio-Help">
<div id="wb_FontAwesomeIcon9" style="position:absolute;left:27px;top:17px;width:238px;height:131px;text-align:center;z-index:468;">
<div id="FontAwesomeIcon9"><i class="fa fa-audio-description">&nbsp;</i></div></div>
<input type="button" id="Button8" onclick="PlayAudio('MediaPlayer2');$('#jQueryDialog5').dialog('open');StopAudio('MediaPlayer3');StopAudio('MediaPlayer4');StopAudio('MediaPlayer5');return false;" name="" value="Explorateur de fichiers" style="position:absolute;left:26px;top:166px;width:241px;height:25px;z-index:469;">
<input type="button" id="Button43" onclick="PlayAudio('MediaPlayer3');$('#jQueryDialog3').dialog('open');StopAudio('MediaPlayer2');StopAudio('MediaPlayer4');StopAudio('MediaPlayer5');return false;" name="" value="Applications Internes" style="position:absolute;left:26px;top:201px;width:241px;height:25px;z-index:470;">
<input type="button" id="Button44" onclick="PlayAudio('MediaPlayer4');ShowObject('Layer1', 1);StopAudio('MediaPlayer2');StopAudio('MediaPlayer3');StopAudio('MediaPlayer5');return false;" name="" value="Fenêtre Bienvenue" style="position:absolute;left:26px;top:237px;width:241px;height:25px;z-index:471;">
<input type="button" id="Button45" onclick="PlayAudio('MediaPlayer5');$('#jQueryDialog11').dialog('open');StopAudio('MediaPlayer2');StopAudio('MediaPlayer3');StopAudio('MediaPlayer4');return false;" name="" value="Paramètres session" style="position:absolute;left:26px;top:272px;width:241px;height:25px;z-index:472;">
</div>

<div id="jQueryDialog87" style="z-index:671;" title="Liligo - Voyages Hotel, Voitures, S&#233;jours [NON COMPATIBLE EN HTTPS]">
...
<div id="jQueryDialog45" style="z-index:674;" title="V&#233;rification des mises &#224; jour WebOS">
<div id="Html14" style="position:absolute;left:14px;top:167px;width:850px;height:77px;z-index:475">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://rynnawebos.fr/login/maj.php">
</iframe></div>
<div id="wb_Text43" style="position:absolute;left:14px;top:68px;width:848px;height:24px;text-align:center;z-index:476;">
<span style="color:#FF6347;font-family:Arial;font-size:21px;"><strong>33.3</strong></span></div>
<div id="wb_Text42" style="position:absolute;left:14px;top:120px;width:460px;height:16px;z-index:477;">
...
<div id="wb_Text46" style="position:absolute;left:14px;top:18px;width:460px;height:16px;z-index:478;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Votre version est actuellement&nbsp;:</span></div>
<div id="wb_Text76" style="position:absolute;left:17px;top:257px;width:847px;height:32px;z-index:479;">
...
<input type="submit" id="Button47" onclick="window.location.href='https://github.com/AlgoStepCompany/RynnaWebOS-Original/archive/master.zip';return false;" name="" value="Télécharger la dernière version disponible du WebOS (code source MASTER officiel et complet)" style="position:absolute;left:12px;top:321px;width:852px;height:25px;z-index:480;">
</div>

<div id="jQueryDialog42" style="z-index:675;" title="[WIDGET] Biblioth&#232;que">
<input type="button" id="Button48" onclick="$('#jQueryDialog46').dialog('open');return false;" name="" value="Ouvrir la Bibliothèque locale" style="position:absolute;left:28px;top:22px;width:215px;height:25px;z-index:481;">
<input type="button" id="Button49" onclick="$('#jQueryDialog47').dialog('open');return false;" name="" value="Télécharger de nouveau e-book" style="position:absolute;left:28px;top:60px;width:215px;height:25px;z-index:482;">
<div id="wb_Image57" style="position:absolute;left:76px;top:97px;width:125px;height:93px;z-index:483;">
...
<div id="jQueryDialog88" style="z-index:678;" title="Annonce g&#233;n&#233;rale (Administrateur)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
...
<div id="jQueryDialog89" style="z-index:682;" title="Informations sur votre session">
<div id="wb_Text80" style="position:absolute;left:11px;top:8px;width:340px;height:64px;z-index:485;">
...
<div id="jQueryDialog90" style="z-index:683;" title="Cloud gratuit (15Go) - 4Sync">
<object data="addeosapps/4sync.php" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog91" style="z-index:684;" title="[WIDGET] Multi-session">
<div id="Html115" style="position:absolute;left:7px;top:18px;width:306px;height:143px;z-index:487">
...
<div id="jQueryDialog92" style="z-index:685;" title="Registre des extensions WebOS (Consultation)">
<textarea name="TextArea2" id="TextArea2" style="position:absolute;left:12px;top:194px;width:728px;height:247px;z-index:488;" rows="12" cols="71" readonly spellcheck="false">EXTENSIONS[
...
<textarea name="TextArea3" id="TextArea3" style="position:absolute;left:12px;top:17px;width:728px;height:154px;z-index:489;" rows="7" cols="71" readonly spellcheck="false">MODULES[
editable_ext=NOK
windows_ext=WIN
text_ext=WEB
images_ext=WEB
...
<input type="submit" id="Button34" onclick="$('#jQueryDialog92').dialog('close');return false;" name="" value="Terminer" style="position:absolute;left:574px;top:471px;width:174px;height:25px;z-index:490;">
</div>
...
<div id="jQueryDialog93" style="z-index:696;" title="Stellarium - Ciel r&#233;aliste en 3D">
...
<div id="wb_Text108" style="position:absolute;left:12px;top:13px;width:540px;height:195px;z-index:492;">
...
<div id="wb_Logout2" style="position:absolute;left:29px;top:25px;width:320px;height:22px;z-index:493;">
...
<div id="wb_Text95" style="position:absolute;left:26px;top:11px;width:325px;height:32px;z-index:494;">
...
<input type="submit" id="Button35" onclick="window.location.href='./session.php';return false;" name="" value="Confirmer le redémarrage" style="position:absolute;left:29px;top:64px;width:322px;height:25px;z-index:495;">
</div>

<div id="Layer5" style="position:absolute;text-align:left;left:0px;top:37px;width:326px;height:521px;z-index:705;">
<div id="wb_LoginName2" style="position:absolute;left:81px;top:20px;width:213px;height:23px;z-index:496;">
...
?> !</span></div>
<div id="wb_FontAwesomeIcon10" style="position:absolute;left:14px;top:10px;width:67px;height:68px;text-align:center;z-index:497;">
<div id="FontAwesomeIcon10"><i class="fa fa-id-badge">&nbsp;</i></div></div>
<div id="wb_FontAwesomeIcon2" style="position:absolute;left:36px;top:90px;width:45px;height:35px;text-align:center;z-index:498;">
...
<div id="wb_Text2" style="position:absolute;left:92px;top:100px;width:190px;height:14px;z-index:499;cursor: pointer;" onclick="$('#jQueryDialog3').dialog('open');ShowObject('Layer5', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applications générales</span></div>
<div id="wb_FontAwesomeIcon19" style="position:absolute;left:36px;top:138px;width:45px;height:36px;text-align:center;z-index:500;">
...
<div id="wb_Text52" style="position:absolute;left:92px;top:146px;width:202px;height:14px;z-index:501;cursor: pointer;" onclick="$('#jQueryDialog19').dialog('open');ShowObject('Layer5', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Rechercher une page précise</span></div>
<div id="wb_FontAwesomeIcon4" style="position:absolute;left:36px;top:185px;width:45px;height:32px;text-align:center;z-index:502;">
...
<div id="wb_Text12" style="position:absolute;left:92px;top:194px;width:202px;height:14px;z-index:503;cursor: pointer;" onclick="$('#jQueryDialog5').dialog('open');ShowObject('Layer5', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Explorateur Fichiers</span></div>
<div id="wb_FontAwesomeIcon7" style="position:absolute;left:36px;top:226px;width:45px;height:42px;text-align:center;z-index:504;">
...
<div id="wb_Text13" style="position:absolute;left:92px;top:238px;width:212px;height:14px;z-index:505;cursor: pointer;" onclick="$('#jQueryDialog54').dialog('open');ShowObject('Layer5', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis de la communautée</span></div>
<div id="wb_FontAwesomeIcon18" style="position:absolute;left:36px;top:276px;width:45px;height:37px;text-align:center;z-index:506;">
...
<div id="wb_Text25" style="position:absolute;left:92px;top:288px;width:212px;height:14px;z-index:507;cursor: pointer;" onclick="$('#jQueryDialog32').dialog('close');$('#jQueryDialog33').dialog('close');$('#jQueryDialog34').dialog('close');$('#jQueryDialog35').dialog('close');$('#jQueryDialog36').dialog('close');$('#jQueryDialog37').dialog('close');$('#jQueryDialog38').dialog('close');$('#jQueryDialog39').dialog('close');ShowObject('Layer5', 0);$('#jQueryDialog11').dialog('open');return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Paramètres et Aides</span></div>
<div id="wb_FontAwesomeIcon14" style="position:absolute;left:36px;top:322px;width:45px;height:39px;text-align:center;z-index:508;">
...
<div id="wb_Text24" style="position:absolute;left:92px;top:336px;width:212px;height:14px;z-index:509;cursor: pointer;" onclick="$('#jQueryDialog8').dialog('open');ShowObject('Layer5', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Navigateur internet</span></div>
<div id="wb_MaterialIcon26" style="position:absolute;left:26px;top:442px;width:41px;height:34px;text-align:center;z-index:510;">
...
<div id="wb_Text28" style="position:absolute;left:14px;top:476px;width:64px;height:24px;text-align:center;z-index:511;">
<span style="color:#FFFFFF;font-family:Arial;font-size:9.3px;">Modifier ma session</span></div>
<hr id="Line4" style="position:absolute;left:11px;top:430px;width:303px;z-index:512;">
<div id="wb_JavaScript3" style="position:absolute;left:81px;top:46px;width:147px;height:23px;z-index:513;">
...
<div id="wb_FontAwesomeIcon3" style="position:absolute;left:107px;top:444px;width:34px;height:30px;text-align:center;z-index:514;">
...
<div id="wb_Text85" style="position:absolute;left:92px;top:476px;width:64px;height:24px;text-align:center;z-index:515;">
<span style="color:#FFFFFF;font-family:Arial;font-size:9.3px;">Changer fond d'écran</span></div>
<div id="wb_FontAwesomeIcon26" style="position:absolute;left:181px;top:444px;width:34px;height:30px;text-align:center;z-index:516;">
<a href="#" onclick="$('#jQueryDialog83').dialog('open');return false;"><div id="FontAwesomeIcon26"><i class="fa fa-flask">&nbsp;</i></div></a></div>
<div id="wb_Text15" style="position:absolute;left:166px;top:476px;width:64px;height:24px;text-align:center;z-index:517;">
<span style="color:#FFFFFF;font-family:Arial;font-size:9.3px;">Ouvrir lecture serveur</span></div>
<div id="wb_FontAwesomeIcon27" style="position:absolute;left:255px;top:444px;width:34px;height:30px;text-align:center;z-index:518;">
...
<div id="wb_Text94" style="position:absolute;left:240px;top:476px;width:64px;height:24px;text-align:center;z-index:519;">
<span style="color:#FFFFFF;font-family:Arial;font-size:9.3px;">Options de session</span></div>
<div id="wb_FontAwesomeIcon29" style="position:absolute;left:38px;top:375px;width:45px;height:39px;text-align:center;z-index:520;">
...
<div id="wb_Text106" style="position:absolute;left:92px;top:387px;width:220px;height:14px;z-index:521;cursor: pointer;" onclick="$('#jQueryDialog96').dialog('open');ShowObject('Layer5', 0);return false;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Lire le manuel d'utilisation</span></div>
</div>
<div id="Layer12" style="position:absolute;text-align:left;left:949px;top:245px;width:593px;height:279px;z-index:706;">
<div id="wb_FontAwesomeIcon11" style="position:absolute;left:12px;top:15px;width:67px;height:68px;text-align:center;z-index:522;">
<div id="FontAwesomeIcon11"><i class="fa fa-id-badge">&nbsp;</i></div></div>
<div id="wb_LoginName1" style="position:absolute;left:89px;top:38px;width:440px;height:23px;z-index:523;">
...
?> ?</span></div>
<div id="wb_FontAwesomeIcon12" style="position:absolute;left:416px;top:97px;width:100px;height:85px;text-align:center;z-index:524;">
...
<div id="wb_FontAwesomeIcon13" style="position:absolute;left:254px;top:97px;width:100px;height:85px;text-align:center;z-index:525;">
...
<div id="wb_FontAwesomeIcon28" style="position:absolute;left:79px;top:97px;width:100px;height:85px;text-align:center;z-index:526;">
<a href="#" onclick="ShowObject('Layer12', 0);return false;"><div id="FontAwesomeIcon28"><i class="fa fa-undo">&nbsp;</i></div></a></div>
<div id="wb_Text19" style="position:absolute;left:59px;top:202px;width:140px;height:36px;text-align:center;z-index:527;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Annuler et revenir à la session</strong></span></div>
<div id="wb_Text20" style="position:absolute;left:234px;top:202px;width:140px;height:36px;text-align:center;z-index:528;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Recharger votre session</strong></span></div>
<div id="wb_Text21" style="position:absolute;left:396px;top:202px;width:140px;height:36px;text-align:center;z-index:529;">
<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><strong>Fermer votre session</strong></span></div>
</div>
<div id="Layer4" style="position:fixed;text-align:right;right:0;top:0;bottom:0;width:118px;z-index:707;" onmouseleave="ShowObject('Layer4', 0);return false;">
<div id="Layer4_Container" style="width:3000px;position:relative;margin-left:auto;margin-right:0;text-align:left;">
<div id="wb_FontAwesomeIcon21" style="position:absolute;left:25px;top:16px;width:78px;height:63px;text-align:center;z-index:530;">
<a href="#" onclick="$('#jQueryDialog70').dialog('open');return false;"><div id="FontAwesomeIcon21"><i class="fa fa-camera">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon22" style="position:absolute;left:25px;top:118px;width:78px;height:68px;text-align:center;z-index:531;">
<a href="#" onclick="$('#jQueryDialog72').dialog('open');return false;"><div id="FontAwesomeIcon22"><i class="fa fa-euro">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon24" style="position:absolute;left:25px;top:325px;width:78px;height:70px;text-align:center;z-index:532;">
...
<div id="wb_FontAwesomeIcon25" style="position:absolute;left:25px;top:435px;width:78px;height:64px;text-align:center;z-index:533;">
<a href="#" onclick="$('#jQueryDialog73').dialog('open');return false;"><div id="FontAwesomeIcon25"><i class="fa fa-save">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon23" style="position:absolute;left:25px;top:227px;width:78px;height:61px;text-align:center;z-index:534;">
<a href="#" onclick="$('#jQueryDialog71').dialog('open');return false;"><div id="FontAwesomeIcon23"><i class="fa fa-calendar">&nbsp;</i></div></a></div>
</div>
</div>
<div id="jQueryDialog52" style="z-index:708;" title="WIDGETS_LOCK">
<div id="wb_Text101" style="position:absolute;left:14px;top:16px;width:371px;height:64px;z-index:535;">
...
<div id="jQueryDialog1" style="z-index:709;" title="MENU_PRINCIPAL_LOCK">
<div id="wb_Text96" style="position:absolute;left:16px;top:20px;width:371px;height:64px;z-index:536;">
<span style="color:#FF0000;font-family:Arial;font-size:13px;"><strong>Ancienne fenêtre de gestion principale liée à une session WebOS.<br>NE PAS SUPPRIMER au risque de provoquer une instabilité du système&nbsp;!</strong></span></div>
</div>
...
<div id="Layer13" style="position:absolute;text-align:left;left:329px;top:37px;width:238px;height:297px;z-index:713;">
<div id="wb_MaterialIcon31" style="position:absolute;left:15px;top:15px;width:52px;height:43px;text-align:center;z-index:537;">
...
<div id="wb_Text53" style="position:absolute;left:79px;top:29px;width:130px;height:15px;z-index:538;">
<span style="color:#FFFFFF;font-family:Arial;font-size:12px;">Notes</span></div>
<div id="wb_Image15" style="position:absolute;left:19px;top:58px;width:43px;height:43px;z-index:539;">
...
<div id="wb_Text3" style="position:absolute;left:79px;top:71px;width:137px;height:15px;z-index:540;">
<span style="color:#FFFFFF;font-family:Arial;font-size:12px;">Calendrier</span></div>
<div id="wb_MaterialIcon61" style="position:absolute;left:21px;top:104px;width:39px;height:37px;text-align:center;z-index:541;">
...
<div id="wb_Text102" style="position:absolute;left:79px;top:115px;width:137px;height:15px;z-index:542;">
<span style="color:#FFFFFF;font-family:Arial;font-size:12px;">Horloge</span></div>
<div id="wb_MaterialIcon37" style="position:absolute;left:20px;top:146px;width:42px;height:36px;text-align:center;z-index:543;">
...
<div id="wb_Text77" style="position:absolute;left:79px;top:159px;width:130px;height:15px;z-index:544;">
<span style="color:#FFFFFF;font-family:Arial;font-size:12px;">Bibliothèque</span></div>
<div id="wb_MaterialIcon35" style="position:absolute;left:21px;top:185px;width:38px;height:40px;text-align:center;z-index:545;">
...
<div id="wb_Text82" style="position:absolute;left:79px;top:199px;width:130px;height:15px;z-index:546;">
...
<div id="wb_Text104" style="position:absolute;left:14px;top:27px;width:371px;height:64px;z-index:548;">
<span style="color:#FF0000;font-family:Arial;font-size:13px;"><strong>Ancienne fenêtre de gestion principale liée à une session WebOS.<br>NE PAS SUPPRIMER au risque de provoquer une instabilité du système&nbsp;!</strong></span></div>
</div>

<div id="jQueryDialog96" style="z-index:715;" title="Manuel d&#39;utilisateur du WebOS">
<object data="manuel.pdf" type="text/html" width="100%" height="100%" style="overflow:hidden" ></object>
</div>

<div id="jQueryDialog97" style="z-index:716;" title="Manuel en vid&#233;o ?">
<div id="wb_Text107" style="position:absolute;left:16px;top:20px;width:396px;height:17px;z-index:550;">
<span style="color:#000000;font-family:Arial;font-size:15px;">Souhaitez-vous plutôt découvrir Rynna WebOS en vidéo&nbsp;?</span></div>
<input type="button" id="Button9" onclick="$('#jQueryDialog96').dialog('close');$('#jQueryDialog97').dialog('close');$('#jQueryDialog98').dialog('open');return false;" name="" value="Oui" style="position:absolute;left:38px;top:78px;width:150px;height:25px;z-index:551;">
<input type="button" id="Button28" onclick="$('#jQueryDialog97').dialog('close');return false;" name="" value="Pas maintenant" style="position:absolute;left:245px;top:78px;width:150px;height:25px;z-index:552;">
</div>

<div id="jQueryDialog98" title="Manuel d&#39;utilisation du WebOS en vid&#233;o (fixe)">
<div id="wb_Shape1" style="position:absolute;left:31px;top:24px;width:966px;height:523px;z-index:553;">
<a href="http://"><img class="hover" src="images/img0005_hover.png" alt="" style="border-width:0;width:966px;height:523px;"><span><img src="images/img0005.png" id="Shape1" alt="" style="width:966px;height:523px;"></span></a></div>
</div>
