...
<body>
<div id="Layer21" style="position:fixed;text-align:left;left:0;right:0;bottom:0;height:15px;z-index:393;" onmouseenter="ShowObject('Layer22', 1);AnimateCss('Layer22', 'animate-fade-in', 5, 500);return false;">
</div>
<div id="Layer1" style="position:absolute;text-align:center;left:2230px;top:1591px;width:755px;height:436px;z-index:394;">
...
<div class="blogitem">
   <span class="blogsubject">Version 9.0</span>
   <div class="no-thumb"></div>
   <div class="blogdate">29/08/17<br></div>
   <span style="color:#000000;">- Ajout du logo US/EN (drapeau) fonctionnel pour un passage du WebOS en Anglais<br>
- Préparation diffusion pour le code source total sur GitHub (inclus version anglaise et les deux versions experimentales du WebOS, Nebular et Luxury)</span><br>
   <div class="blogcomments"></div>
</div>
<div class="clearfix visible-col1"></div>
<div class="blogitem">
   <span class="blogsubject">Version 8.9</span>
   <div class="no-thumb"></div>
   <div class="blogdate">28/08/17<br></div>
   <span style="color:#000000;">- Ajout d'un détecteur de résolution d'écran intégré en SCRIPT (bloc HTML intégré) pour pouvoir vérifier de plus larges résolutions d'écran si besoin</span><br>
   <div class="blogcomments"></div>
</div>
<div class="clearfix visible-col1"></div>
<div class="blogitem">
   <span class="blogsubject">Version 8.8</span>
   <div class="no-thumb"></div>
   <div class="blogdate">27/08/17<br></div>
   <span style="color:#000000;">- Ajustement des images générées par WOFF</span><br>
   <div class="blogcomments"></div>
</div>
<div class="clearfix visible-col1"></div>
<div class="blogitem">
   <span class="blogsubject">Version 8.7</span>
   <div class="no-thumb"></div>
   <div class="blogdate">26/08/17<br></div>
   <span style="color:#000000;">- Amélioration de l'interface et des animations<br>
- Modification d'un icone et son comportement dans la BottomBar<br>
- Préparation à la mise en ligne du prochain code source (objectif 9.0) incluant une traduction complète du système en Anglais<br>
- Ajout d'un logo du WebOS sur l'écran de connexion<br>
- Ajout d'un icone drapeau ANGLAIS sur la page de connexion (objectif traduction anglaise pour la version 9.0)</span><br>
   <div class="blogcomments"></div>
</div>
<div class="clearfix visible-col1"></div>
<div class="blogitem">
   <span class="blogsubject">Version 8.6(b)</span>
   <div class="no-thumb"></div>
   <div class="blogdate">24/08/17<br></div>
   <span style="color:#000000;">- Ajout de la BottomBar qui vous permettra d'afficher (en pop-up) les sites internet les plus utiles<br>
- Inclus animation plugin 3D dynamique du BottomBar</span><br>
   <div class="blogcomments"></div>
</div>
<div class="clearfix visible-col1"></div>
<div class="blogitem">
   <span class="blogsubject">Version 8.6</span>
   <div class="no-thumb"></div>
   <div class="blogdate">23/08/17<br></div>
   <span style="color:#000000;">- Nettoyage des anciens codes ou fonctions non utiles dans la session<br>
- Nouveauté : un aperçu des applications sont maintenant disponible en 3D si vous laissez la souris plus de 3 secondes sur un icone bureautique<br>
- Nouveauté : amélioration des connexions (PHP 7)<br>
</span><span style="color:#FF0000;">Un défaut a été rencontré et n'a pas encore été corrigé : des fois le chargement de la session (écran de chargement orangé) est très lent et double voir triple sont temps d'affichage avant de se fermer. Ceci sera résolu au plus vite, mais ne gêne en rien votre utilisation du WebOS.</span><br>
   <div class="blogcomments"></div>
</div>
<div class="clearfix visible-col1"></div>
</div>
...
<a href="#" onclick="ShowObject('wb_PageHeader', 0);TimerStartTimer8();return false;"><div id="MaterialIcon27"><i class="material-icons">&#xe8b2;</i></div></a>
</div>
<div id="wb_MaterialIcon4" style="display:inline-block;width:36px;height:36px;text-align:center;z-index:19;">
<div id="MaterialIcon4"><i class="material-icons">&#xe5d4;</i></div>
</div>
<div id="wb_MaterialIcon30" style="display:inline-block;width:36px;height:36px;text-align:center;z-index:20;">
...
<div id="wb_MaterialIcon33" style="display:inline-block;width:36px;height:36px;text-align:center;z-index:21;">
<div id="MaterialIcon33"><i class="material-icons">&#xe5d4;</i></div>
</div>
<div id="wb_MaterialIcon19" style="display:inline-block;width:36px;height:36px;text-align:center;z-index:22;">
...
<div id="wb_MaterialIcon28" style="display:inline-block;width:36px;height:36px;text-align:center;z-index:23;">
<a href="#" onclick="$('#jQueryDialog6').dialog('open');return false;"><div id="MaterialIcon28"><i class="material-icons">&#xe879;</i></div></a>
</div>
</div>
<div class="col-2">
<div id="wb_MaterialIcon62" style="display:inline-block;width:36px;height:36px;text-align:center;z-index:24;">
...
<div id="wb_LayoutGrid1" ondblclick="$('#jQueryDialog17').dialog('open');return false;" ondragover="MoveObject('wb_Image2',0,0);return false;">
<div id="LayoutGrid1">
<div class="row">
<div class="col-1">
<div id="wb_Image2" style="display:inline-block;width:90px;height:105px;z-index:25;">
...
<div class="col-2">
<div id="wb_Image36" style="display:inline-block;width:90px;height:105px;z-index:26;">
...
<div id="wb_LayoutGrid6" ondblclick="$('#jQueryDialog17').dialog('open');return false;" ondragover="MoveObject('wb_Image2',0,0);return false;">
<div id="LayoutGrid6">
<div class="row">
<div class="col-1">
<div id="wb_Image13" style="display:inline-block;width:82px;height:96px;z-index:27;">
...
<div class="col-2">
<div id="wb_Image19" style="display:inline-block;width:87px;height:101px;z-index:28;">
...
<div id="wb_LayoutGrid5" ondblclick="$('#jQueryDialog17').dialog('open');return false;" ondragover="MoveObject('wb_Image2',0,0);return false;">
<div id="LayoutGrid5">
<div class="row">
<div class="col-1">
<div id="wb_Image38" style="display:inline-block;width:84px;height:98px;z-index:29;">
...
<div id="wb_LayoutGrid4" ondblclick="$('#jQueryDialog17').dialog('open');return false;" ondragover="MoveObject('wb_Image2',0,0);return false;">
<div id="LayoutGrid4">
<div class="row">
<div class="col-1">
...
<div id="wb_LayoutGrid3" ondblclick="$('#jQueryDialog17').dialog('open');return false;" ondragover="MoveObject('wb_Image2',0,0);return false;">
<div id="LayoutGrid3">
<div class="row">
<div class="col-1">
<div id="wb_Image34" style="display:inline-block;width:84px;height:98px;z-index:33;">
...
<div id="jQueryDialog3" style="z-index:402;" title="Mes applications install&#233;es (Applis G&#233;n&#233;rales)">
...
<div id="wb_MaterialIcon2" style="position:absolute;left:16px;top:495px;width:32px;height:32px;text-align:center;z-index:48;">
...
<div id="wb_Text63" style="position:absolute;left:512px;top:86px;width:55px;height:16px;text-align:center;z-index:51;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Ipiccy</span></div>
<div id="wb_Image3" style="position:absolute;left:499px;top:9px;width:86px;height:86px;z-index:52;">
...
<div id="wb_Text67" style="position:absolute;left:512px;top:209px;width:55px;height:32px;text-align:center;z-index:57;">
...
<div id="wb_Image21" style="position:absolute;left:500px;top:130px;width:85px;height:86px;z-index:64;">
...
<div id="wb_Text105" style="position:absolute;left:428px;top:343px;width:59px;height:28px;text-align:center;z-index:74;">
<span style="color:#000000;font-family:Arial;font-size:11px;">HITEK<br>Plein écran</span></div>
</div>

<div id="jQueryDialog4" style="z-index:403;" title="Calculatrice (system/program/calculatrice)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/calc.php">
</iframe>
</div>

<div id="jQueryDialog5" style="z-index:404;" title="Explorateur de fichiers - Votre espace personnel (1Go maximum)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="myexplorer.php">
</iframe><br />
</div>

<div id="jQueryDialog8" style="z-index:405;" title="Navigateur web Qwant (all&#233;g&#233;, sans onglet)">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/navigateur.php">
</iframe>
</div>

<div id="jQueryDialog14" style="z-index:406;" title="Editeur de texte (FullPro CK Series 2016)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="system/program/texteditor/editor.html">
</iframe><br />
</div>

<div id="jQueryDialog19" style="z-index:407;" title="Rynna Search (Rechercher une page du WebOS)">
...
<div id="jQueryDialog23" style="z-index:408;" title="Jeu de Hasard (system/program/dee)">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/deeint.php">
</iframe>
</div>

<div id="jQueryDialog28" style="z-index:409;" title="WordPad - Editeur de texte avanc&#233;">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/wordpad.php">
</iframe>
</div>

<div id="jQueryDialog7" style="z-index:410;" title="Informations sur votre location - M&#233;t&#233;o temps r&#233;el [HTTPS non compatible]">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
...
<div id="jQueryDialog11" style="z-index:414;" title="Param&#232;tres et aides suppl&#233;mentaires">
...
<div id="jQueryDialog33" style="z-index:415;" title="Test de votre connexion internet">
...
<div id="jQueryDialog41" style="z-index:418;" title="Gestionnaire de Jeux">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="gamemanager.php">
</iframe><br />
</div>

<div id="jQueryDialog20" style="z-index:419;" title="D&#233;part RER SNCF par ville (system/program/sncfappli) [HTTPS non compatible]">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/sncf.php">
</iframe>
</div>

<div id="jQueryDialog16" style="z-index:420;" title="StreetView">
<iframe
  width="100%"
  height="100%"
...
<div id="jQueryDialog12" style="z-index:421;" title="Applications virtualis&#233;es">
...
<div id="jQueryDialog27" style="z-index:422;" title="Docteur Flashy - Analyse de votre ordinateur">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/doctorflashy.php">
</iframe>
</div>

<div id="jQueryDialog10" style="z-index:423;" title="Chat WebOS (Publique)">
...
<div id="jQueryDialog29" style="z-index:424;" title="AVERTISSEMENT">
...
<div id="jQueryDialog36" style="z-index:425;" title="Configuration clavier">
...
<input type="text" id="Editbox1" style="position:absolute;left:10px;top:126px;width:529px;height:16px;line-height:16px;z-index:138;" name="Editbox1" value="" spellcheck="false" title="Tester votre clavier ici m&#234;me">
<div id="wb_JavaScript1" style="position:absolute;left:14px;top:165px;width:535px;height:151px;z-index:139;">
<script>
...
<div id="jQueryDialog37" style="z-index:426;" title="Configuration de votre interface personnelle">
<div id="wb_MaterialIcon18" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:140;">
...
<div id="wb_Text50" style="position:absolute;left:15px;top:55px;width:243px;height:16px;z-index:141;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Choisissez un fond d'écran personnel :</span></div>
<div id="wb_Text48" style="position:absolute;left:210px;top:225px;width:251px;height:16px;text-align:center;z-index:142;">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Prochainement disponible !</strong></span></div>
</div>

<div id="jQueryDialog38" style="z-index:427;" title="Calendrier d&#233;taill&#233;">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://www.2017calendrier.fr/">
</iframe><br />
</div>

<div id="jQueryDialog25" style="z-index:428;" title="Calculateur Euro (system/program/eurocalc)">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/calceuro.php">
</iframe>
</div>

<div id="jQueryDialog24" style="z-index:429;" title="Horloge interactive (system/program/horloge)">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/horlogeint.php">
</iframe>
</div>

<div id="jQueryDialog34" style="z-index:430;" title="Affichage de votre adresse IP [Ne fonctionne pas en HHTPS]">
<div id="wb_MaterialIcon15" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:146;">
...
<div id="Html21" style="position:absolute;left:51px;top:10px;width:666px;height:153px;z-index:147">
ADRESSE IP : 
<?
...
<div id="jQueryDialog39" style="z-index:431;" title="Verification de la protection">
<div id="wb_MaterialIcon20" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:148;">
...
<div id="wb_MaterialIcon21" style="position:absolute;left:48px;top:10px;width:106px;height:100px;text-align:center;z-index:149;">
<div id="MaterialIcon21"><i class="material-icons">&#xe32a;</i></div></div>
<div id="wb_Text37" style="position:absolute;left:168px;top:30px;width:290px;height:80px;text-align:justify;z-index:150;">
...
<div id="jQueryDialog40" style="z-index:432;" title="Editeur 3D Tridiv CSS 3">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/tridiv3d.php">
</iframe>
</div>

<div id="jQueryDialog35" style="z-index:433;" title="Supprimer votre compte">
<div id="wb_Text34" style="position:absolute;left:12px;top:61px;width:377px;height:112px;z-index:152;">
...
<div id="wb_MaterialIcon16" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:153;">
...
<div id="jQueryDialog42" style="z-index:434;" title="Applications d&#39;Entreprise">
<div id="wb_Image25" style="position:absolute;left:130px;top:17px;width:173px;height:119px;z-index:154;">
<img src="images/logoentreprisesource.png" id="Image25" alt=""></div>
<div id="wb_Image26" style="position:absolute;left:46px;top:157px;width:60px;height:60px;z-index:155;">
<a href="#" onclick="$('#jQueryDialog43').dialog('open');return false;"><img src="images/appli1.png" id="Image26" alt=""></a></div>
<div id="wb_Text38" style="position:absolute;left:29px;top:229px;width:96px;height:34px;text-align:center;z-index:156;">
<span style="color:#000000;font-family:Arial;font-size:15px;">DESCRIPTIF APPLI 1</span></div>
<div id="wb_Image27" style="position:absolute;left:186px;top:157px;width:60px;height:60px;z-index:157;">
<a href="#" onclick="$('#jQueryDialog44').dialog('open');return false;"><img src="images/appli2.png" id="Image27" alt=""></a></div>
<div id="wb_Image28" style="position:absolute;left:330px;top:157px;width:60px;height:60px;z-index:158;">
<a href="#" onclick="$('#jQueryDialog45').dialog('open');return false;"><img src="images/appli3.png" id="Image28" alt=""></a></div>
<div id="wb_Image29" style="position:absolute;left:47px;top:319px;width:60px;height:60px;z-index:159;">
<a href="#" onclick="$('#jQueryDialog46').dialog('open');return false;"><img src="images/appli4.png" id="Image29" alt=""></a></div>
<div id="wb_Image30" style="position:absolute;left:186px;top:319px;width:60px;height:60px;z-index:160;">
<a href="#" onclick="$('#jQueryDialog47').dialog('open');return false;"><img src="images/appli5.png" id="Image30" alt=""></a></div>
<div id="wb_Image31" style="position:absolute;left:330px;top:319px;width:60px;height:60px;z-index:161;">
<a href="#" onclick="$('#jQueryDialog48').dialog('open');return false;"><img src="images/appli6.png" id="Image31" alt=""></a></div>
<div id="wb_Text39" style="position:absolute;left:168px;top:229px;width:96px;height:34px;text-align:center;z-index:162;">
<span style="color:#000000;font-family:Arial;font-size:15px;">DESCRIPTIF APPLI 2</span></div>
<div id="wb_Text40" style="position:absolute;left:312px;top:229px;width:96px;height:34px;text-align:center;z-index:163;">
<span style="color:#000000;font-family:Arial;font-size:15px;">DESCRIPTIF APPLI 3</span></div>
<div id="wb_Text41" style="position:absolute;left:312px;top:394px;width:96px;height:34px;text-align:center;z-index:164;">
<span style="color:#000000;font-family:Arial;font-size:15px;">DESCRIPTIF APPLI 6</span></div>
<div id="wb_Text42" style="position:absolute;left:168px;top:394px;width:96px;height:34px;text-align:center;z-index:165;">
<span style="color:#000000;font-family:Arial;font-size:15px;">DESCRIPTIF APPLI 5</span></div>
<div id="wb_Text43" style="position:absolute;left:29px;top:394px;width:96px;height:34px;text-align:center;z-index:166;">
<span style="color:#000000;font-family:Arial;font-size:15px;">DESCRIPTIF APPLI 4</span></div>
<div id="wb_Text44" style="position:absolute;left:7px;top:475px;width:332px;height:16px;z-index:167;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Développeur : cet espace est réservé à votre Entreprise</span></div>
<input type="submit" id="Button8" onclick="$('#jQueryDialog49').dialog('open');return false;" name="" value="INFOS ?" style="position:absolute;left:347px;top:466px;width:96px;height:25px;z-index:168;">
</div>

<div id="jQueryDialog43" style="z-index:435;" title="[APPLICATION CORRESPONDANTE ICONE 1 - ENTREPRISE]">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="infoentreprise.html">
</iframe>
</div>

<div id="jQueryDialog44" style="z-index:436;" title="[APPLICATION CORRESPONDANTE ICONE 2 - ENTREPRISE]">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="infoentreprise.html">
</iframe>
</div>

<div id="jQueryDialog45" style="z-index:437;" title="[APPLICATION CORRESPONDANTE ICONE 3 - ENTREPRISE]">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="infoentreprise.html">
</iframe>
</div>

<div id="jQueryDialog46" style="z-index:438;" title="[APPLICATION CORRESPONDANTE ICONE 4 - ENTREPRISE]">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="infoentreprise.html">
</iframe>
</div>

<div id="jQueryDialog47" style="z-index:439;" title="[APPLICATION CORRESPONDANTE ICONE 5 - ENTREPRISE]">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="infoentreprise.html">
</iframe>
</div>

<div id="jQueryDialog48" style="z-index:440;" title="[APPLICATION CORRESPONDANTE ICONE 6 - ENTREPRISE]">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="infoentreprise.html">
</iframe>
</div>
...
<div id="jQueryDialog49" style="z-index:444;" title="Informations pour d&#233;veloppeurs">
<div id="wb_Text45" style="position:absolute;left:12px;top:15px;width:524px;height:304px;z-index:175;">
...
<div id="wb_Text47" style="position:absolute;left:11px;top:15px;width:592px;height:48px;z-index:195;">
...
<div id="jQueryTabs4" style="position:absolute;left:11px;top:65px;width:584px;height:398px;z-index:196;">
<ul>
...
<input type="button" id="Button10" onclick="$('#jQueryDialog1').dialog('close');return false;" name="" value="Menu Applicatifs" style="position:absolute;left:16px;top:58px;width:251px;height:25px;z-index:176;">
<input type="button" id="Button11" onclick="$('#jQueryDialog3').dialog('close');return false;" name="" value="Applis installées" style="position:absolute;left:309px;top:58px;width:251px;height:25px;z-index:177;">
<input type="button" id="Button13" onclick="$('#jQueryDialog9').dialog('close');return false;" name="" value="Application Windows" style="position:absolute;left:16px;top:93px;width:251px;height:25px;z-index:178;">
<input type="button" id="Button14" onclick="$('#jQueryDialog13').dialog('close');return false;" name="" value="Messagerie NetCourriel" style="position:absolute;left:309px;top:93px;width:251px;height:25px;z-index:179;">
<input type="button" id="Button16" onclick="$('#jQueryDialog31').dialog('close');return false;" name="" value="Dépôt Applications" style="position:absolute;left:16px;top:130px;width:251px;height:25px;z-index:180;">
<input type="button" id="Button17" onclick="$('#jQueryDialog16').dialog('close');return false;" name="" value="Street View" style="position:absolute;left:309px;top:130px;width:251px;height:25px;z-index:181;">
<input type="button" id="Button18" onclick="$('#jQueryDialog12').dialog('close');return false;" name="" value="Applications virtualisées" style="position:absolute;left:16px;top:167px;width:251px;height:25px;z-index:182;">
<input type="button" id="Button19" onclick="$('#jQueryDialog10').dialog('close');return false;" name="" value="Chat WebOS" style="position:absolute;left:309px;top:167px;width:251px;height:25px;z-index:183;">
<input type="button" id="Button20" onclick="$('#jQueryDialog40').dialog('close');return false;" name="" value="Editeur 3D Tridiv" style="position:absolute;left:16px;top:204px;width:251px;height:25px;z-index:184;">
<input type="button" id="Button21" onclick="$('#jQueryDialog42').dialog('close');return false;" name="" value="Applications d'Entreprise" style="position:absolute;left:309px;top:204px;width:251px;height:25px;z-index:185;">
<input type="button" id="Button22" onclick="$('#jQueryDialog11').dialog('close');return false;" name="" value="Paramètres et Aides" style="position:absolute;left:16px;top:240px;width:251px;height:25px;z-index:186;">
<input type="button" id="Button23" onclick="$('#jQueryDialog41').dialog('close');return false;" name="" value="Gestionnaire de jeux" style="position:absolute;left:309px;top:240px;width:251px;height:25px;z-index:187;">
<input type="button" id="Button24" onclick="$('#jQueryDialog19').dialog('close');return false;" name="" value="Terminal renseignements" style="position:absolute;left:16px;top:278px;width:251px;height:25px;z-index:188;">
<input type="button" id="Button25" onclick="$('#jQueryDialog8').dialog('close');return false;" name="" value="Navigateur Web Qwant" style="position:absolute;left:309px;top:278px;width:251px;height:25px;z-index:189;">
<input type="button" id="Button26" onclick="$('#jQueryDialog5').dialog('close');return false;" name="" value="Explorateur de fichiers" style="position:absolute;left:16px;top:315px;width:251px;height:25px;z-index:190;">
<input type="button" id="Button27" onclick="$('#jQueryDialog21').dialog('close');return false;" name="" value="Fenêtre de Bienvenue" style="position:absolute;left:309px;top:315px;width:251px;height:25px;z-index:191;">
<div id="wb_Text49" style="position:absolute;left:16px;top:372px;width:513px;height:16px;z-index:192;">
...
<div id="wb_Text28" style="position:absolute;left:168px;top:203px;width:249px;height:16px;text-align:center;z-index:193;">
...
<div id="wb_JavaScript2" style="position:absolute;left:21px;top:59px;width:555px;height:301px;z-index:194;">
<script>
document.write("<div style='font-family:Arial;font-size:12px;color:#000000;text-decoration:none;font-weight:normal;font-style:normal;text-align:left;text-decoration:none'>" + navigator.appName + " " + navigator.appVersion + "<\/div>");
</script>
...
<div id="jQueryDialog53" style="z-index:449;" title="[WIDGET] Notes">
<textarea name="TextArea1" id="TextArea1" style="position:absolute;left:14px;top:11px;width:238px;height:166px;z-index:216;" rows="9" cols="37" spellcheck="false"></textarea>
</div>

<div id="jQueryDialog15" style="z-index:450;" title="[WIDGET] Calendrier">
<input type="text" id="jQueryDatePicker1" style="position:absolute;left:18px;top:6px;width:236px;height:164px;line-height:164px;z-index:217;" name="jQueryDatePicker1" value="" spellcheck="false">
</div>


<div id="jQueryDialog30" style="z-index:452;" title="Concepteur d&#39;application Web (alpha 0.2)">
<input type="submit" id="Button3" onclick="$('#jQueryDialog22').dialog('open');return false;" name="" value="Ouvrir le concepteur d'application Web (version PHP/HTML)" style="position:absolute;left:45px;top:86px;width:404px;height:25px;z-index:218;">
<div id="wb_Text8" style="position:absolute;left:15px;top:17px;width:451px;height:48px;text-align:justify;z-index:219;">
...
<div id="jQueryDialog22" style="z-index:453;" title="Concepteur d&#39;applications Web (version PHP)">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="generatiug/generatiugtest.php">
</iframe>
</div>

<div id="jQueryDialog54" style="z-index:454;" title="Applis Web Communautaires">
...
<div id="jQueryDialog51" style="z-index:456;" title="Forum Veler Software (d&#233;veloppement Rynna WebOS et divers projets)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://forumvelersoftware.bbactif.com/t2085-rynna-webos-natif-projet-mini-webos-by-algostep-company">
</iframe>
</div>

<div id="jQueryDialog56" style="z-index:457;" title="Ipiccy - Retouches photos en ligne">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/ipiccy.php">
</iframe>
</div>

<div id="jQueryDialog57" style="z-index:458;" title="Le Bon Coin - Ventes et achats en ligne en France">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/leboncoin.php">
</iframe>
</div>

<div id="jQueryDialog58" style="z-index:459;" title="Orange TV - toutes vos chaines en ligne (stream)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/orangetv.php">
</iframe>
</div>

<div id="jQueryDialog59" style="z-index:460;" title="PrintFriendly - Votre page web au format PDF imprimable">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/webpdf.php">
</iframe>
</div>

<div id="jQueryDialog60" style="z-index:461;" title="01net - Blog, actualit&#233;s et logiciels informatiques et nouvelle technologie">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/01net.php">
</iframe>
</div>

<div id="jQueryDialog61" style="z-index:462;" title="CDiscount">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
...
<input type="button" id="Button5" onclick="window.location.href='./session.php';return false;" name="" value="Redémarrer la session" style="position:absolute;left:18px;top:17px;width:420px;height:25px;z-index:229;">
<input type="button" id="Button28" onclick="$('#jQueryDialog6').dialog('close');return false;" name="" value="Annuler et revenir au bureau" style="position:absolute;left:18px;top:95px;width:420px;height:25px;z-index:230;">
<div id="wb_Logout1" style="position:absolute;left:18px;top:55px;width:418px;height:23px;z-index:231;">
...
<div id="jQueryDialog1" style="z-index:465;" title="Menu Applicatifs">
<div id="wb_FontAwesomeIcon2" style="position:absolute;left:12px;top:12px;width:72px;height:64px;text-align:center;z-index:232;">
...
<div id="wb_Text2" style="position:absolute;left:7px;top:84px;width:77px;height:28px;text-align:center;z-index:233;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis générales</span></div>
<div id="wb_FontAwesomeIcon4" style="position:absolute;left:202px;top:14px;width:73px;height:61px;text-align:center;z-index:234;">
...
<div id="wb_FontAwesomeIcon7" style="position:absolute;left:304px;top:15px;width:67px;height:56px;text-align:center;z-index:235;">
...
<div id="wb_FontAwesomeIcon11" style="position:absolute;left:111px;top:132px;width:61px;height:50px;text-align:center;z-index:236;">
...
<div id="wb_FontAwesomeIcon12" style="position:absolute;left:197px;top:132px;width:78px;height:49px;text-align:center;z-index:237;">
...
<div id="wb_Text12" style="position:absolute;left:199px;top:82px;width:76px;height:28px;text-align:center;z-index:238;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Explorateur Fichiers</span></div>
<div id="wb_Text13" style="position:absolute;left:295px;top:84px;width:86px;height:28px;text-align:center;z-index:239;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis de la communautée</span></div>
<div id="wb_Text18" style="position:absolute;left:9px;top:198px;width:75px;height:28px;text-align:center;z-index:240;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis Entreprise</span></div>
<div id="wb_Text19" style="position:absolute;left:106px;top:198px;width:70px;height:28px;text-align:center;z-index:241;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Applis Virtualisées</span></div>
<div id="wb_Text20" style="position:absolute;left:199px;top:198px;width:76px;height:14px;text-align:center;z-index:242;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Street-View</span></div>
<div id="wb_FontAwesomeIcon13" style="position:absolute;left:303px;top:132px;width:69px;height:50px;text-align:center;z-index:243;">
...
<div id="wb_FontAwesomeIcon14" style="position:absolute;left:396px;top:132px;width:71px;height:49px;text-align:center;z-index:244;">
...
<div id="wb_FontAwesomeIcon18" style="position:absolute;left:396px;top:15px;width:70px;height:54px;text-align:center;z-index:245;">
...
<div id="wb_FontAwesomeIcon19" style="position:absolute;left:109px;top:15px;width:64px;height:56px;text-align:center;z-index:246;">
...
<div id="wb_Text21" style="position:absolute;left:302px;top:198px;width:70px;height:28px;text-align:center;z-index:247;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Messagerie Net-C</span></div>
<div id="wb_Text24" style="position:absolute;left:402px;top:198px;width:65px;height:28px;text-align:center;z-index:248;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Navigateur Qwant</span></div>
<div id="wb_Text25" style="position:absolute;left:393px;top:84px;width:77px;height:28px;text-align:center;z-index:249;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Paramètres &amp; Aides</span></div>
<div id="wb_Text52" style="position:absolute;left:103px;top:85px;width:73px;height:14px;text-align:center;z-index:250;">
<span style="color:#FFFFFF;font-family:Arial;font-size:11px;">Rynna Search</span></div>
<div id="wb_JavaScript3" style="position:absolute;left:320px;top:378px;width:147px;height:23px;z-index:251;">
...
<hr id="Line1" style="position:absolute;left:15px;top:366px;width:452px;height:1px;z-index:252;">
<div id="wb_FontAwesomeIcon10" style="position:absolute;left:12px;top:132px;width:69px;height:59px;text-align:center;z-index:253;">
...
<div id="wb_LoginName1" style="position:absolute;left:17px;top:378px;width:278px;height:23px;z-index:254;">
...
<div id="wb_Text103" style="position:absolute;left:15px;top:19px;width:438px;height:112px;z-index:255;">
<span style="color:#DC143C;font-family:Arial;font-size:13px;"><strong>Une erreur inconnu est survenue !<br>Nous ne pouvons rien faire pour vous...<br><br>Nous vous conseillons d'attendre une mise à jour du WebOS pour poursuivre l'action demandée.<br><br>Merci pour votre patience.</strong></span></div>
</div>

<div id="jQueryDialog17" style="z-index:467;" title="Actions sur les icones">
<button type="button" id="jQueryButton2" onclick="alert('Prochainement');$('#jQueryDialog17').dialog('close');return false;" name="" value="Supprimer un icone" style="position:absolute;left:25px;top:58px;width:191px;height:36px;z-index:274;">Supprimer un icone</button>
<button type="button" id="jQueryButton3" onclick="ShowObject('wb_LayoutGrid1', 0);ShowObject('wb_LayoutGrid3', 0);ShowObject('wb_LayoutGrid4', 0);ShowObject('wb_LayoutGrid5', 0);ShowObject('wb_LayoutGrid6', 0);TimerStartTimer2();$('#jQueryDialog17').dialog('close');return false;" name="" value="Actualiser les icones" style="position:absolute;left:25px;top:99px;width:191px;height:36px;z-index:275;">Actualiser les icones</button>
<button type="button" id="jQueryButton1" onclick="alert('Prochainement');$('#jQueryDialog17').dialog('close');return false;" name="" value="Créer un icone" style="position:absolute;left:25px;top:18px;width:191px;height:36px;z-index:276;">Créer un icone</button>
</div>
...
<div id="Layer2" style="position:fixed;text-align:center;left:0;top:0;right:0;bottom:0;z-index:469;">
<div id="Layer2_Container" style="width:3000px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
<script>
var wb_Timer4;
...
<div id="Layer3" style="position:fixed;text-align:center;left:0;top:0;right:0;bottom:0;z-index:470;" onclick="Toggle('Layer3', 'slidedown', 1200);ShowObject('wb_PageHeader', 0);ShowObject('wb_LayoutGrid1', 0);ShowObject('wb_LayoutGrid3', 0);ShowObject('wb_LayoutGrid4', 0);ShowObject('wb_LayoutGrid5', 0);ShowObject('wb_LayoutGrid6', 0);TimerStartTimer9();return false;">
...
<div id="wb_Text89" style="position:absolute;left:9px;top:12px;width:364px;height:48px;text-align:justify;z-index:281;">
...
<input type="button" id="Button29" onclick="$('#jQueryDialog18').dialog('close');return false;" name="" value="NON" style="position:absolute;left:11px;top:81px;width:96px;height:25px;z-index:282;">
<input type="submit" id="Button30" onclick="window.location.href='./modifuser.php';return false;" name="" value="OUI" style="position:absolute;left:262px;top:81px;width:96px;height:25px;z-index:283;">
</div>

<div id="jQueryDialog2" style="z-index:472;" title="Gestion des erreurs (Kernel PHP)">
<div id="wb_MaterialIcon55" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:284;">
...
<div id="wb_Text91" style="position:absolute;left:73px;top:19px;width:347px;height:16px;z-index:285;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Listes des erreurs gérées par le WebOS :</span></div>
<table style="position:absolute;left:23px;top:60px;width:401px;height:350px;z-index:286;" id="Table1">
<tr>
...
<input type="button" id="Button1" onclick="ShowObject('wb_PageHeader', 0);TimerStartTimer8();return false;" name="" value="Cliquez ici pour ouvrir le Gestionnaire de Tâches" style="position:absolute;left:23px;top:415px;width:401px;height:25px;z-index:287;">
</div>

<div id="jQueryDialog26" style="z-index:473;" title="Changer de langues">
<div id="wb_MaterialIcon56" style="position:absolute;left:4px;top:10px;width:37px;height:37px;text-align:center;z-index:288;">
...
<div id="wb_Text92" style="position:absolute;left:73px;top:19px;width:347px;height:192px;z-index:289;">
...
<div id="jQueryDialog64" style="z-index:474;" title="Simulateur Smartphone">
<div id="wb_Text94" style="position:absolute;left:13px;top:13px;width:321px;height:96px;z-index:290;">
...
<input type="text" id="Editbox2" style="position:absolute;left:17px;top:120px;width:307px;height:16px;line-height:16px;z-index:291;" name="Editbox2" value="http://lien-site.fr (Non disponible pour le moment...)" disabled spellcheck="false">
<input type="button" id="Button31" onclick="$('#jQueryDialog65').dialog('open');$('#jQueryDialog64').dialog('close');return false;" name="" value="Simultauer iPhone 8 (iPhone O)" style="position:absolute;left:17px;top:161px;width:317px;height:25px;z-index:292;">
<input type="button" id="Button32" onclick="$('#jQueryDialog66').dialog('open');$('#jQueryDialog64').dialog('close');return false;" name="" value="Simultauer Samsung Galaxy s8" style="position:absolute;left:17px;top:204px;width:317px;height:25px;z-index:293;">
</div>

<div id="jQueryDialog65" style="z-index:475;" title="Simulateur iPhone 8 (iPhone O) (test de sites Web et WebApps)">
<div id="Html18" style="position:absolute;left:54px;top:42px;width:265px;height:585px;overflow:hidden;z-index:294">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/laposte.php">
</iframe></div>
<div id="wb_Image41" style="position:absolute;left:101px;top:42px;width:178px;height:29px;z-index:295;">
<img src="images/iphone8_simulation_haut.png" id="Image41" alt=""></div>
<div id="wb_MaterialIcon57" style="position:absolute;left:544px;top:25px;width:40px;height:41px;text-align:center;z-index:296;">
<div id="MaterialIcon57"><i class="material-icons">&#xe5d5;</i></div></div>
<input type="button" id="Button33" name="" value="Action bouton central (sous écran)" style="position:absolute;left:354px;top:109px;width:222px;height:25px;z-index:297;" disabled>
<input type="button" id="Button34" name="" value="Page précédente" style="position:absolute;left:354px;top:150px;width:222px;height:25px;z-index:298;" disabled>
<input type="button" id="Button35" name="" value="Page suivante" style="position:absolute;left:354px;top:193px;width:222px;height:25px;z-index:299;" disabled>
<input type="button" id="Button36" name="" value="Version iOS" style="position:absolute;left:354px;top:237px;width:222px;height:25px;z-index:300;" disabled>
<input type="button" id="Button37" onclick="$('#jQueryDialog64').dialog('open');$('#jQueryDialog65').dialog('close');return false;" name="" value="Retour Simuateur" style="position:absolute;left:354px;top:616px;width:222px;height:25px;z-index:301;">
<div id="wb_Text95" style="position:absolute;left:354px;top:282px;width:222px;height:96px;z-index:302;">
...
<div id="wb_Image40" style="position:absolute;left:31px;top:25px;width:307px;height:616px;z-index:303;">
<img src="images/nue_iphone8_design_final_2018.png" id="Image40" alt=""></div>
<div id="wb_Text97" style="position:absolute;left:-1px;top:6px;width:474px;height:15px;z-index:304;">
...
<div id="jQueryDialog66" style="z-index:476;" title="Simulateur Samsung Galaxy s8 (test de sites Web et WebApps)">
<div id="Html20" style="position:absolute;left:70px;top:58px;width:270px;height:562px;overflow:hidden;z-index:305">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/laposte.php">
</iframe></div>
...
<input type="button" id="Button41" name="" value="Version Android" style="position:absolute;left:370px;top:237px;width:222px;height:25px;z-index:310;" disabled>
...
<div id="wb_Text96" style="position:absolute;left:370px;top:282px;width:222px;height:96px;z-index:312;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Information :<br>Dans ce prototype de simulation smartphone vous ne pouvez pas encore naviguer dans le site affiché.<br>Ceci sera possible lorsque nous auront améliorer le programme.</span></div>
...
<div id="wb_Text98" style="position:absolute;left:8px;top:6px;width:474px;height:15px;z-index:314;">
<span style="color:#000000;font-family:Arial;font-size:12px;">Simulateur Smartphone conçu par AlgoStep Company - service gratuit</span></div>
</div>

<div id="jQueryDialog67" style="z-index:477;" title="Envoi rapide">
<div id="wb_Extension1" style="position:absolute;left:21px;top:66px;width:845px;height:218px;z-index:315;">
<div id="Extension1">
...
<div id="wb_Text100" style="position:absolute;left:27px;top:13px;width:832px;height:48px;z-index:316;">
...
<div id="jQueryDialog13" style="z-index:478;" title="Messagerie personelle Europ&#233;enne (Net Courriel)">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
...
<div id="jQueryDialog69" style="z-index:480;" title="[WIDGET] Horloge">
<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
   src="addeosapps/horloge.php">
</iframe>
</div>

<div id="Layer4" style="position:fixed;text-align:right;right:0;top:0;bottom:0;width:118px;z-index:481;" onmouseleave="ShowObject('Layer4', 0);return false;">
<div id="Layer4_Container" style="width:3000px;position:relative;margin-left:auto;margin-right:0;text-align:left;">
<div id="wb_FontAwesomeIcon21" style="position:absolute;left:25px;top:16px;width:78px;height:63px;text-align:center;z-index:319;">
<a href="#" onclick="$('#jQueryDialog70').dialog('open');return false;"><div id="FontAwesomeIcon21"><i class="fa fa-camera">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon22" style="position:absolute;left:25px;top:118px;width:78px;height:68px;text-align:center;z-index:320;">
<a href="#" onclick="$('#jQueryDialog72').dialog('open');return false;"><div id="FontAwesomeIcon22"><i class="fa fa-fax">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon24" style="position:absolute;left:25px;top:325px;width:78px;height:70px;text-align:center;z-index:321;">
...
<div id="wb_FontAwesomeIcon25" style="position:absolute;left:25px;top:435px;width:78px;height:64px;text-align:center;z-index:322;">
<a href="#" onclick="$('#jQueryDialog73').dialog('open');return false;"><div id="FontAwesomeIcon25"><i class="fa fa-save">&nbsp;</i></div></a></div>
<div id="wb_FontAwesomeIcon23" style="position:absolute;left:25px;top:227px;width:78px;height:61px;text-align:center;z-index:323;">
...
<div id="jQueryDialog70" style="z-index:483;" title="Webcam">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/webcam.php">
</iframe>
</div>

<div id="jQueryDialog71" style="z-index:484;" title="Calendrier g&#233;n&#233;ral">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/agenda.php">
</iframe>
</div>

<div id="Layer5" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:485;" onclick="ShowObject('Layer5', 0);return false;">
<div id="wb_TextArt1" style="position:absolute;left:119px;top:44px;width:815px;height:23px;z-index:327;">
...
<div id="Layer6" style="position:absolute;text-align:left;left:119px;top:147px;width:1046px;height:592px;z-index:328;">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="http://hitek.fr/actualite">
</iframe>
</div>
<div id="wb_Image44" style="position:absolute;left:31px;top:30px;width:64px;height:50px;z-index:329;">
<img src="images/placeholder.gif" data-src="images/logo.png" id="Image44" alt=""></div>
<div id="wb_Text104" style="position:absolute;left:4px;top:0px;width:247px;height:14px;z-index:330;">
...
<div id="jQueryDialog72" style="z-index:487;" title="Devises">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/devise.php">
</iframe>
</div>

<div id="jQueryDialog73" style="z-index:488;" title="Sauvegarde local de votre session">
<div id="wb_Text106" style="position:absolute;left:11px;top:12px;width:650px;height:160px;z-index:333;">
...
<div id="Layer7" style="position:fixed;text-align:left;left:0;top:0;right:0;bottom:0;z-index:490;">
<div id="Layer8" style="position:absolute;text-align:left;left:150px;top:82px;width:855px;height:460px;z-index:337;">
<div id="Layer9" style="position:absolute;text-align:left;left:16px;top:11px;width:218px;height:436px;z-index:334;" onclick="$('#jQueryDialog3').dialog('open');ShowObject('Layer7', 0);return false;">
</div>
<div id="Layer10" style="position:absolute;text-align:left;left:236px;top:11px;width:211px;height:436px;z-index:335;" onclick="$('#jQueryDialog5').dialog('open');ShowObject('Layer7', 0);return false;">
</div>
<div id="Layer11" style="position:absolute;text-align:left;left:453px;top:11px;width:373px;height:436px;z-index:336;" onclick="$('#jQueryDialog11').dialog('open');ShowObject('Layer7', 0);return false;">
</div>
</div>
<div id="wb_Text107" style="position:absolute;left:4px;top:7px;width:249px;height:14px;z-index:338;">
<span style="color:#000000;font-family:Arial;font-size:11px;"><em>Test interactif 3D non dynamique</em></span></div>
</div>
<div id="jQueryDialog74" style="z-index:491;" title="Bienvenue dans la session de d&#233;monstration !">
<div id="wb_Text108" style="position:absolute;left:15px;top:12px;width:540px;height:195px;z-index:342;">
...
<div id="jQueryDialog32" style="z-index:492;" title="Informations sur le WebOS">
<div id="wb_Text32" style="position:absolute;left:16px;top:56px;width:609px;height:400px;z-index:343;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Rynna WebOS est un WebOS libre d'utilisation pour tous.<br>Son code source est disponible publiquement sur le dépôt GitHub.<br><br><strong>Liste des développeurs : <br></strong><br><em>Société AlgoStep Company :<br></em><br>Loïc A.<br>Jeremy N. (plus disponible)<br>Maxime D.<br><br><em>Développeurs qui ont aidés à son développement ou pour leurs avis (remerciements) : <br></em><br>Polien (veler Software)<br>Softwarezatorman (veler Software)<br>Lereparateurdepc (veler Software)<br>Etienne Baudoux (IRL)<br>Jeremy60800 (veler Software)<br>Fandeonepiece2 (veler Software)<br>Coincero (veler Software)<br>Maxime G. (IRL)<br>Random Coder 99 (OpenClassRoom)<br><br>Merci à tout nos amies à Rouen pour leurs conseils et leurs professionnalismes durant le développement long et fastidieux de ce projet !</span></div>
...
<div id="Layer12" style="position:absolute;text-align:left;left:1339px;top:13549px;width:473px;height:591px;z-index:493;">
<script>
var wb_Timer13;
...
<div id="Layer13" style="position:absolute;text-align:left;left:1842px;top:13549px;width:473px;height:591px;z-index:494;">
<script>
var wb_Timer16;
...
<div id="Layer14" style="position:absolute;text-align:left;left:2388px;top:13549px;width:473px;height:591px;z-index:495;">
<script>
var wb_Timer19;
...
<div id="Layer15" style="position:absolute;text-align:left;left:1339px;top:14166px;width:473px;height:591px;z-index:496;">
<script>
var wb_Timer22;
...
<div id="Layer16" style="position:absolute;text-align:left;left:1842px;top:14166px;width:473px;height:591px;z-index:497;">
<script>
var wb_Timer25;
...
<div id="Layer17" style="position:absolute;text-align:left;left:2371px;top:14150px;width:473px;height:591px;z-index:498;">
<script>
var wb_Timer28;
...
<div id="Layer18" style="position:absolute;text-align:left;left:1328px;top:14775px;width:473px;height:591px;z-index:499;">
<script>
var wb_Timer31;
...
<div id="Layer19" style="position:absolute;text-align:left;left:1867px;top:14775px;width:473px;height:591px;z-index:500;">
<script>
var wb_Timer34;
...
<div id="Layer20" style="position:absolute;text-align:left;left:2432px;top:14775px;width:473px;height:591px;z-index:501;">
<script>
var wb_Timer37;
...
<div id="jQueryDialog52" style="z-index:502;" title="Choisir un Widget ?">
<div id="wb_MaterialIcon31" style="position:absolute;left:10px;top:13px;width:67px;height:63px;text-align:center;z-index:372;">
...
<div id="wb_Text53" style="position:absolute;left:14px;top:82px;width:59px;height:15px;text-align:center;z-index:373;">
<span style="color:#FFFFFF;font-family:Arial;font-size:12px;">Notes</span></div>
<div id="wb_Image15" style="position:absolute;left:95px;top:14px;width:62px;height:62px;z-index:374;">
...
<div id="wb_Text3" style="position:absolute;left:97px;top:82px;width:59px;height:30px;text-align:center;z-index:375;">
<span style="color:#FFFFFF;font-family:Arial;font-size:12px;">Calendrier</span></div>
<div id="wb_MaterialIcon61" style="position:absolute;left:176px;top:14px;width:62px;height:59px;text-align:center;z-index:376;">
...
<div id="wb_Text102" style="position:absolute;left:177px;top:82px;width:61px;height:15px;text-align:center;z-index:377;">
...
<div id="Layer22" style="position:absolute;text-align:left;left:348px;top:5968px;width:1099px;height:152px;z-index:504;" onmouseleave="ShowObject('Layer22', 0);return false;">
...
<div id="jQueryDialog9" style="z-index:506;" title="Wikip&#233;dia">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/wikipedia.php">
</iframe>
</div>

<div id="jQueryDialog31" style="z-index:507;" title="Le Monde - Actualit&#233;s de France">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/lemonde.php">
</iframe>
</div>

<div id="jQueryDialog55" style="z-index:508;" title="Forum Etienne BAUDOUX - Forum li&#233; au projet Rynna WebOS">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/sz.php">
</iframe>
</div>

<div id="jQueryDialog68" style="z-index:509;" title="OpenClassRoom - Tutoriels et cours en ligne">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/ocr.php">
</iframe>
</div>

<div id="jQueryDialog75" style="z-index:510;" title="SUMO PAINT - Dessin (demonstration gratuite)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/paint.php">
</iframe>
</div>

<div id="jQueryDialog76" style="z-index:511;" title="Now-Coworking - Espace Coworking pour votre Entreprise">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
   src="addeosapps/nowcoworking.php">
</iframe>
</div>

<div id="jQueryDialog62" style="z-index:512;" title="Notes dropbox - FARGO (gratuit)">
<iframe width="100%" height="100%" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"
