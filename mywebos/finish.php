...
<div id="wb_Text1" style="position:absolute;left:23px;top:23px;width:732px;height:55px;text-align:center;z-index:0;">
<span style="color:#FFFFFF;font-family:Arial;font-size:27px;">Bienvenue sur Wemya !<br></span><span style="color:#FFFFFF;font-family:Arial;font-size:20px;">Nous terminons de configurer votre compte, c'est bientôt terminé...</span></div>
<div id="wb_Image1" style="position:absolute;left:291px;top:97px;width:197px;height:200px;z-index:1;">
<img src="images/loadcreateuserclean.gif" id="Image1" alt=""></div>
</div>
</div>
<script>
var wb_Timer1;
