...
<link href="cloud4.css" rel="stylesheet">
<script src="jquery-3.3.1.min.js"></script>
<script src="wb.fileuploader.min.js"></script>
<script>
$(document).ready(function()
{
$('#wb_Extension1').FileUploader({ headings: ['Nom', 'Taille', 'Vider la liste'], script: 'cloud4_app_png.php' });
});
</script>
</head>
<body>
...
<span style="color:#0000FF;font-family:Arial;font-size:16px;"><strong>Etape 3 - Hébergement du fichier image/logo representatif de l'application (.png)</strong></span></div>
<input type="submit" id="Button1" onclick="window.location.href='./cloud5.php';return false;" name="" value="J'ai déposé, Suivant !" style="position:absolute;left:364px;top:376px;width:290px;height:25px;z-index:2;">
<div id="wb_Text2" style="position:absolute;left:21px;top:89px;width:633px;height:16px;z-index:3;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Choisissez maintenant le fichier image/logo (format .Png) à héberger sur le Cloud Applicatif Web Public :</span></div>
<input type="submit" id="Button3" onclick="window.location.href='./cloud3.php';return false;" name="" value="Retour arrière" style="position:absolute;left:21px;top:376px;width:181px;height:25px;z-index:4;">
<div id="wb_Extension1" style="position:absolute;left:21px;top:119px;width:633px;height:212px;z-index:5;">
<div id="Extension1">
<div class="upload-drop-target"><h2>Glisser et déposer votre fichier image logo ici (format PNG, maxi 100x100)</h2></div>
