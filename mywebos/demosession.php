...
<input type="submit" id="Button35" onclick="window.location.href='./reboot.php';return false;" name="" value="Confirmer le redémarrage" style="position:absolute;left:29px;top:64px;width:322px;height:25px;z-index:540;">
</div>
