...
<link href="412.css" rel="stylesheet">
...
<span style="color:#000000;font-family:Arial;font-size:16px;"><strong>Préconditions envoyées par la requête non-vérifiées (request_error_41). Cette erreur s'affiche si vous avez un problème de requête SQL si vous utilisez le WebOS en local en MySQL sur Wamp ou Lamp).<br><br>ERREUR CLIENT-USER (412)</strong></span></div>
