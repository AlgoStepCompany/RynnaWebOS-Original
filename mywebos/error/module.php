...
<span style="color:#000000;font-family:Arial;font-size:16px;"><strong>Impossible de charger un module spécifique (lié au dossier '.include'). Contacter les développeurs du WebOS pour vérifier si ce problème serveur peut être réparé le plus rapidement possible.<br><br>ERREUR WEBOS INTERNE (APPLET_MODULE)</strong></span></div>
