...
<div id="wb_Text2" style="position:absolute;left:25px;top:167px;width:576px;height:114px;z-index:1;">
<span style="color:#000000;font-family:Arial;font-size:16px;"><strong>Impossible de charger une interface JQuery (lié au dossier 'rynnawebosv3'). Il est possible qu'un fichier Jquery soit manquant sur le serveur (ou soit corrompu) ; contactez rapidement les développeurs du WebOS.<br><br>ERREUR WEBOS INTERNE (APPLET_JQUERY)</strong></span></div>
